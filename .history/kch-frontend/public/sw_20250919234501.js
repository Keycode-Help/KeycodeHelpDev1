...
self.addEventListener('fetch', (event) => {
  ...
  // Handle API requests
  if (url.pathname.startsWith('/api/') || url.pathname.startsWith('/auth/') || url.pathname.startsWith('/user/') || url.pathname.startsWith('/trial/') || url.pathname.startsWith('/kch-database/') || url.pathname.startsWith('/pricelist')) {
