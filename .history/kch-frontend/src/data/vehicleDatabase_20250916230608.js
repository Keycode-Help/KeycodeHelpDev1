...
export const vehicleDatabase = {
  ...
  Dodge: {
    ...
    models: {
      ...
      Viper: { years: generateYearRange(1995, 2002).concat(generateYearRange(2003, 2010)).concat(generateYearRange(2013, 2017)) },
  ...
  Toyota: {
    ...
    models: {
      ...
      Supra: { years: generateYearRange(1995, 2002).concat(generateYearRange(2020)) },
  ...
  Chevrolet: {
    ...
    models: {
      ...
      Camaro: { years: generateYearRange(1995, 2002).concat(generateYearRange(2010)) },
