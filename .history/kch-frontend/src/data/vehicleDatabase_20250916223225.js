...
export const vehicleDatabase = {
  ...
  Ford: {
    ...
    models: {
      ...
      Transit: { years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
      "Transit Connect": { years: [2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
    },
  },
  Lincoln: {
    basePrice: 70.0,
  ...
  Toyota: {
    ...
    models: {
      ...
      "Prius Prime": { years: [2017, 2018, 2019, 2020, 2021, 2022, 2023, 2024] },
