...
export const vehicleDatabase = {
  ...
  Acura: {
    ...
    models: {
      ...
      NSX: {
        years: generateYearRange(1991, 2005).concat(
          generateYearRange(2016, 2022)
        ),
      },
      ...
      Integra: {
        years: generateYearRange(1986, 2001).concat(generateYearRange(2023)),
      },
  ...
  Honda: {
    ...
    models: {
      ...
      Passport: {
        years: generateYearRange(1994, 2002).concat(generateYearRange(2019)),
      },
      "HR-V": { years: generateYearRange(2016) },
      Odyssey: { years: generateYearRange(1999) },
      Fit: { years: generateYearRange(2007, 2020) },
      Insight: {
        years: generateYearRange(2000, 2006)
          .concat(generateYearRange(2010, 2014))
          .concat(generateYearRange(2019, 2022)),
      },
  ...
  Jeep: {
    ...
    models: {
      ...
      Cherokee: {
        years: generateYearRange(1984, 2001).concat(generateYearRange(2014)),
      },
      Compass: {
        years: generateYearRange(2007, 2017).concat(generateYearRange(2017)),
      },
      ...
      Wagoneer: {
        years: generateYearRange(1963, 1991).concat(generateYearRange(2022)),
      },
      "Grand Wagoneer": {
        years: generateYearRange(1984, 1991).concat(generateYearRange(2022)),
      },
  ...
  Ford: {
    ...
    models: {
      ...
      Ranger: {
        years: generateYearRange(1983, 2011).concat(generateYearRange(2019)),
      },
      Bronco: {
        years: generateYearRange(1966, 1996).concat(generateYearRange(2021)),
      },
      ...
      Taurus: {
        years: generateYearRange(1986, 2007).concat(
          generateYearRange(2008, 2019)
        ),
      },
  ...
  Lincoln: {
    ...
    models: {
      ...
      Continental: {
        years: generateYearRange(1961, 2002).concat(
          generateYearRange(2017, 2020)
        ),
      },
  ...
  Chevrolet: {
    ...
    models: {
      ...
      Malibu: {
        years: generateYearRange(1964, 1983)
          .concat(generateYearRange(1997, 2003))
          .concat(generateYearRange(2004)),
      },
      Impala: {
        years: generateYearRange(1958, 1985)
          .concat(generateYearRange(1994, 1996))
          .concat(generateYearRange(2000, 2020)),
      },
