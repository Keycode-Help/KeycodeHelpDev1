// Helper function to generate year ranges
...
export const vehicleDatabase = {
  ...
  Acura: {
    ...
    models: {
      ...
      NSX: { years: generateYearRange(1991, 2005).concat(generateYearRange(2016, 2022)) },
      TSX: { years: generateYearRange(2004, 2014) },
      ZDX: { years: generateYearRange(2010, 2013) },
      CDX: { years: generateYearRange(2017, 2021) },
      Integra: { years: generateYearRange(1986, 2001).concat(generateYearRange(2023)) },
      ...
      Vigor: { years: generateYearRange(1992, 1994) },
      Legend: { years: generateYearRange(1991, 1995) },
    },
  },
  Honda: {
    basePrice: 60.0,
    ...
    models: {
      ...
      Ridgeline: { years: generateYearRange(2006, 2014).concat(generateYearRange(2017)) },
      Passport: { years: generateYearRange(1994, 2002).concat(generateYearRange(2019)) },
      ...
      "del Sol": { years: generateYearRange(1993, 1997) },
      CRX: { years: generateYearRange(1988, 1991) },
      "Civic del Sol": { years: generateYearRange(1993, 1997) },
      "CR-X": { years: generateYearRange(1984, 1991) },
    },
  },
  ...
  Dodge: {
    ...
    models: {
      ...
      Durango: { years: generateYearRange(1998, 2009).concat(generateYearRange(2011)) },
      Journey: { years: generateYearRange(2009, 2020) },
      "Grand Caravan": { years: generateYearRange(1996, 2020) },
      Avenger: { years: generateYearRange(1995, 2000).concat(generateYearRange(2008, 2014)) },
      Caliber: { years: generateYearRange(2007, 2012) },
      Magnum: { years: generateYearRange(2005, 2008) },
      Nitro: { years: generateYearRange(2007, 2011) },
      Viper: { years: generateYearRange(1992, 2002).concat(generateYearRange(2003, 2010)).concat(generateYearRange(2013, 2017)) },
  ...
  Jeep: {
    ...
    requiresPin: true,
    models: {
      Wrangler: { years: generateYearRange(1987) },
      "Grand Cherokee": { years: generateYearRange(1993) },
      Cherokee: { years: generateYearRange(1984, 2001).concat(generateYearRange(2014)) },
      Compass: { years: generateYearRange(2007, 2017).concat(generateYearRange(2017)) },
      ...
      Wagoneer: { years: generateYearRange(1963, 1991).concat(generateYearRange(2022)) },
      "Grand Wagoneer": { years: generateYearRange(1984, 1991).concat(generateYearRange(2022)) },
      CJ5: { years: generateYearRange(1955, 1983) },
      CJ7: { years: generateYearRange(1976, 1986) },
      CJ8: { years: generateYearRange(1981, 1986) },
      Scrambler: { years: generateYearRange(1981, 1985) },
      Comanche: { years: generateYearRange(1986, 1992) },
      "J10": { years: generateYearRange(1974, 1988) },
      "J20": { years: generateYearRange(1974, 1988) },
    },
  },
  ...
  Ford: {
    ...
    models: {
      "F-150": { years: generateYearRange(1975) },
      ...
      Mustang: { years: generateYearRange(1994) },
      Explorer: { years: generateYearRange(1991) },
      Escape: { years: generateYearRange(2001) },
      Edge: { years: generateYearRange(2007) },
      Expedition: { years: generateYearRange(1997) },
      Ranger: { years: generateYearRange(1983, 2011).concat(generateYearRange(2019)) },
      Bronco: { years: generateYearRange(1966, 1996).concat(generateYearRange(2021)) },
      ...
      Taurus: { years: generateYearRange(1986, 2007).concat(generateYearRange(2008, 2019)) },
      ...
      "Crown Victoria": { years: generateYearRange(1992, 2011) },
      "Grand Marquis": { years: generateYearRange(1992, 2011) },
      ...
      "Bronco II": { years: generateYearRange(1984, 1990) },
      Aerostar: { years: generateYearRange(1986, 1997) },
      Contour: { years: generateYearRange(1995, 2000) },
      Mystique: { years: generateYearRange(1995, 2000) },
      Probe: { years: generateYearRange(1989, 1997) },
      Thunderbird: { years: generateYearRange(1955, 2005) },
  ...
  Lincoln: {
    ...
    models: {
      ...
      Aviator: { years: generateYearRange(2003, 2005).concat(generateYearRange(2020)) },
      ...
      Continental: { years: generateYearRange(1961, 2002).concat(generateYearRange(2017, 2020)) },
      "Town Car": { years: generateYearRange(1981, 2011) },
      LS: { years: generateYearRange(2000, 2006) },
      Zephyr: { years: generateYearRange(2006) },
      Blackwood: { years: generateYearRange(2002, 2003) },
      "Mark VII": { years: generateYearRange(1984, 1992) },
      "Mark VIII": { years: generateYearRange(1993, 1998) },
      "Mark LT": { years: generateYearRange(2006, 2008) },
      Versailles: { years: generateYearRange(1977, 1980) },
    },
  },
  ...
  Toyota: {
    ...
    models: {
      ...
      Venza: { years: generateYearRange(2009, 2015).concat(generateYearRange(2021)) },
      ...
      Supra: { years: generateYearRange(1979, 2002).concat(generateYearRange(2020)) },
  ...
  Chevrolet: {
    ...
    models: {
      ...
      Camaro: { years: generateYearRange(1967, 2002).concat(generateYearRange(2010)) },
      Corvette: { years: generateYearRange(1953) },
      Equinox: { years: generateYearRange(2005) },
      Traverse: { years: generateYearRange(2009) },
      Tahoe: { years: generateYearRange(1995) },
      Suburban: { years: generateYearRange(1992) },
      Colorado: { years: generateYearRange(2004, 2012).concat(generateYearRange(2015)) },
      Malibu: { years: generateYearRange(1964, 1983).concat(generateYearRange(1997, 2003)).concat(generateYearRange(2004)) },
      Impala: { years: generateYearRange(1958, 1985).concat(generateYearRange(1994, 1996)).concat(generateYearRange(2000, 2020)) },
      Cruze: { years: generateYearRange(2011, 2019) },
      Trax: { years: generateYearRange(2015, 2022) },
      Blazer: { years: generateYearRange(1969, 1994).concat(generateYearRange(2019)) },
      "Bolt EV": { years: [2017, 2018, 2019, 2020, 2021, 2022, 2023] },
      "Bolt EUV": { years: [2022, 2023] },
      Spark: {
        years: [2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021, 2022],
      },
      Sonic: { years: [2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2020] },
      Volt: { years: [2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019] },
      HHR: { years: [2006, 2007, 2008, 2009, 2010, 2011] },
      Cobalt: { years: [2005, 2006, 2007, 2008, 2009, 2010] },
      Aveo: { years: [2004, 2005, 2006, 2007, 2008, 2009, 2010, 2011] },
      "Monte Carlo": {
        years: [2000, 2001, 2002, 2003, 2004, 2005, 2006, 2007],
      },
      "Captiva Sport": { years: [2012, 2013, 2014, 2015] },
      "City Express": { years: [2015, 2016, 2017, 2018] },
      "Express 1500": {
        years: [
