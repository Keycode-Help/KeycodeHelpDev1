...
export const vehicleDatabase = {
  ...
  BMW: {
    ...
    memberPrice: 70.0,
    category: "BMW",
    availabilityNote: "Limited keycode availability - contact support for specific models",
  ...
  Tesla: {
    ...
    memberPrice: 0.0,
    category: "Tesla",
    availabilityNote: "Tesla keycodes are not currently available - contact Tesla directly",
    notAvailable: true,
    models: {
