...
export const vehicleDatabase = {
  ...
  Ford: {
    ...
    models: {
      ...
      Fiesta: { years: [2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019] },
      Fusion: {
        years: [
      ...
      "C-Max": { years: [2013, 2014, 2015, 2016, 2017, 2018] },
      "Five Hundred": { years: [2005, 2006, 2007] },
      Freestyle: { years: [2005, 2006, 2007] },
      "Crown Victoria": {
