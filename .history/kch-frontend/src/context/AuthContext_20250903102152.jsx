        ...
        if (token) {
          ...
          try {
            ...
            if (error.name === "AbortError" || error.code === "ECONNABORTED") {
              ...
              console.warn(
                "Backend auth endpoint returned 403 - JWT token may be invalid, but keeping local auth state for now"
              );
              // Don't logout immediately on 403 - this could be a temporary backend issue
              // Keep the user logged in locally and let them continue using the app
              // Only logout if they actually try to access a protected resource and get 401
            } else if (
