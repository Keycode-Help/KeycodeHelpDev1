        ...
        if (token && storedUser && storedToken) {
          ...
          try {
            ...
            if (error.name === "AbortError" || error.code === "ECONNABORTED") {
              ...
              console.warn(
                "Backend auth endpoint returned 403 - JWT token is invalid (likely secret mismatch), clearing auth state"
              );
              // 403 on /auth/me usually means JWT secret mismatch - clear auth state and force re-login
              logout();
            } else if (
