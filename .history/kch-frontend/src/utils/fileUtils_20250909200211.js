...
export const getOptimizedImageUrl = (imageData, maxBase64Length = 100000) => {
  ...
  if (base64String.length > maxBase64Length) {
    console.log(
      "🔍 getOptimizedImageUrl: Converting to blob URL (large image)"
    );
    const blobUrl = base64ToBlobUrl(base64String, mimeType);
    console.log(
      "🔍 getOptimizedImageUrl: Blob URL created",
      blobUrl ? "success" : "failed"
    );
    return blobUrl;
  } else {
    ...
    console.log(
      "🔍 getOptimizedImageUrl: Data URL created",
