...
function SuperAdminDashboard() {
  ...
  const [createForm, setCreateForm] = useState({ email: "", password: "", fname: "", lname: "", phone: "" });
  ...
  const createSuperAdmin = async (e) => {
    ...
    try {
      ...
      setCreateForm({ email: "", password: "", fname: "", lname: "", phone: "" });
    } catch (err) {
      alert("Failed to create super admin. Only approved super admins can perform this action.");
    }
  };
    ...
    <div className="relative">
      ...
      <div className="mx-auto max-w-6xl px-4 md:px-6 py-10 relative">
        ...
        <div className="mb-6 grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <form onSubmit={createSuperAdmin} className="glass-card rounded-2xl border border-[var(--border)] p-4 grid grid-cols-1 md:grid-cols-6 gap-2 items-center">
            <div className="md:col-span-6 text-white font-medium">Create Super Admin</div>
            <input value={createForm.email} onChange={(e)=>setCreateForm(f=>({...f,email:e.target.value}))} placeholder="Email" className="rounded-lg bg-black/30 border border-[var(--border)] text-white placeholder-gray-400 p-2 focus:outline-none focus:ring-2 focus:ring-yellow-500" required />
            <input type="password" value={createForm.password} onChange={(e)=>setCreateForm(f=>({...f,password:e.target.value}))} placeholder="Temp Password" className="rounded-lg bg-black/30 border border-[var(--border)] text-white placeholder-gray-400 p-2 focus:outline-none focus:ring-2 focus:ring-yellow-500" required />
            <input value={createForm.fname} onChange={(e)=>setCreateForm(f=>({...f,fname:e.target.value}))} placeholder="First name" className="rounded-lg bg-black/30 border border-[var(--border)] text-white placeholder-gray-400 p-2 focus:outline-none focus:ring-2 focus:ring-yellow-500" />
            <input value={createForm.lname} onChange={(e)=>setCreateForm(f=>({...f,lname:e.target.value}))} placeholder="Last name" className="rounded-lg bg-black/30 border border-[var(--border)] text-white placeholder-gray-400 p-2 focus:outline-none focus:ring-2 focus:ring-yellow-500" />
            <input value={createForm.phone} onChange={(e)=>setCreateForm(f=>({...f,phone:e.target.value}))} placeholder="Phone (optional)" className="rounded-lg bg-black/30 border border-[var(--border)] text-white placeholder-gray-400 p-2 focus:outline-none focus:ring-2 focus:ring-yellow-500" />
            <button type="submit" className="rounded-xl bg-emerald-500/90 hover:bg-emerald-500 text-white font-semibold px-4 py-2">Create</button>
          </form>
        </div>
