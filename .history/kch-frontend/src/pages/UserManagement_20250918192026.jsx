          ...
          <div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50 p-4">
            <div className="bg-slate-800 rounded-2xl p-8 max-w-md w-full">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-red-300 text-sm">
                      This action will permanently deactivate the user account. The user will lose access to all services and their data will be preserved for compliance purposes.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex gap-3">
                ...
                <button
                  onClick={() => handleDeleteUser(userToDelete.id, deleteReason)}
