        ...
        <div className="mb-10 space-y-8">
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-3xl p-6 shadow-xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                <label className="text-sm font-semibold text-gray-300">Status Filter</label>
                <select
                  name="status"
                ...
                >
                  ...
                  <option value="FULFILLED" className="bg-slate-800 text-white">Fulfilled</option>
                </select>
              </div>
              <div className="space-y-2">
                <label className="text-sm font-semibold text-gray-300">Sort Options</label>
                <div className="flex gap-2">
                  ...
                  >
                    ...
                    <option value="confirmationnumber" className="bg-slate-800 text-white">Confirmation</option>
                  ...
                  <select
                    ...
                    style={{ colorScheme: "dark" }}
                  >
                    <option value="asc" className="bg-slate-800 text-white">Asc</option>
                    <option value="desc" className="bg-slate-800 text-white">Desc</option>
                  </select>
                </div>
              </div>
            </div>
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-3xl p-6 shadow-xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 border border-yellow-500/20 rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="text-gray-400 text-sm font-semibold mb-2">Pending Requests</div>
              ...
              <div className="bg-gradient-to-br from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="text-gray-400 text-sm font-semibold mb-2">Pending Users</div>
              ...
              <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="text-gray-400 text-sm font-semibold mb-2">In Progress</div>
                <div className="text-white text-3xl font-bold">{inProgressRequests.length}</div>
              </div>
              <div className="bg-gradient-to-br from-emerald-500/10 to-green-500/10 border border-emerald-500/20 rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="text-gray-400 text-sm font-semibold mb-2">Transactions</div>
                <div className="text-white text-3xl font-bold">{transactions.length}</div>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <section className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-3xl p-8 shadow-xl">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="text-white font-bold text-2xl">Subscriptions</h2>
                  <p className="text-gray-400 text-sm">Active user subscriptions</p>
                </div>
              </div>
            ...
            <section className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-3xl p-8 shadow-xl">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm">Users awaiting approval</p>
                </div>
              </div>
            ...
            <section className="lg:col-span-2 bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-3xl p-8 shadow-xl">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="text-white font-bold text-2xl">Pending Requests</h2>
                  <p className="text-gray-400 text-sm">Keycode requests awaiting processing</p>
                </div>
              </div>
