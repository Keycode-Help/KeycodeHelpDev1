          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <ul>
                ...
                <li>
                  <strong>Immediate Effect:</strong> Cancellations take effect
                  at end of billing period
                </li>
                <li>
                  <strong>Easy Process:</strong> Cancel through account settings
                  or contact support
                </li>
              </ul>
            </div>
            ...
            <div className="policy-card">
              ...
              <div className="refund-scenario">
                ...
                <ul>
                  ...
                  <li>
                    <strong>Next Charge:</strong> No charges after cancellation
                  </li>
                </ul>
              </div>
              ...
              <div className="policy-note">
                ...
                <p>
                  ...
                  month, you'll have access until the end of that month, but no
                  refund for the remaining 15 days.
                </p>
              </div>
            </div>
          </section>
            ...
            <div className="policy-card">
              ...
              <div className="refund-scenario">
                ...
                <ul>
                  ...
                  <li>
                    <strong>Refund Policy:</strong> Prorated refunds for unused
                    months
                  </li>
                  <li>
              ...
              <div className="policy-note">
                ...
                <p>
                  <strong>Example:</strong> If you cancel after 6 months on an
                  annual plan, you'll receive a refund for the remaining 6
                  months (50% of annual fee).
                </p>
              </div>
            </div>
          </section>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <div className="refund-scenario">
                <h4>💰 Monthly Plans</h4>
                <p>
                  <strong>No Refunds:</strong> Monthly plans are non-refundable
              ...
              <div className="refund-scenario">
                <h4>💰 Annual Plans</h4>
                <p>
                  <strong>Prorated Refunds:</strong> Calculate unused months and
              ...
              <div className="request-methods">
                ...
                <div className="method">
                  ...
                  <p>
                    ...
                    <strong>cancellations@keycodehelp.com</strong>
                  </p>
              ...
              <div className="refund-process">
                <div className="process-step">
                  ...
                  <div className="step-content">
                    ...
                    <p>
                      You'll receive immediate confirmation of your cancellation
                      request
                    </p>
                  </div>
                </div>
                ...
                <div className="process-step">
                  ...
                  <div className="step-content">
                    ...
                    <p>
                      Full access to all features until current billing period
                      ends
                    </p>
                  </div>
                </div>
                ...
                <div className="process-step">
                  ...
                  <div className="step-content">
                    ...
                    <p>
                      Annual plan refunds processed within 5-10 business days
                    </p>
                  </div>
                </div>
                ...
                <div className="process-step">
                  ...
                  <div className="step-content">
                    ...
                    <p>
                      Account becomes inactive but data is preserved for 30 days
                    </p>
                  </div>
                </div>
              </div>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <div className="refund-scenario">
                ...
                <ul>
                  <li>
                    <strong>Anytime:</strong> You can reactivate your account at
                    any time
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Data Recovery:</strong> Your previous data may be
                    restored
                  </li>
                  <li>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <p>
                ...
                policy at any time. Changes will be communicated through email
                notifications and website updates. Your cancellation rights at
