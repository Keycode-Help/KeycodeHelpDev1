...
const PricelistPage = () => {
  ...
  const filteredManufacturers = Object.entries(manufacturerPricing).filter(([name, data]) => {
    const matchesSearch = name.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         data.description.toLowerCase().includes(searchTerm.toLowerCase()) ||
                         data.popularModels.some(model => model.toLowerCase().includes(searchTerm.toLowerCase()));
    const matchesFilter = selectedManufacturer === "all" || name === selectedManufacturer;
      ...
      <div className="bg-gradient-to-r from-blue-900 to-purple-900 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Transparent pricing for every vehicle brand. Get your keycode quickly and affordably 
            with our manufacturer-specific pricing structure.
          </p>
        </div>
      </div>
              ...
              >
                ...
                <div className="text-center mb-6">
                  <div className="w-16 h-16 mx-auto mb-4 bg-gray-700 rounded-lg flex items-center justify-center">
                    <span className="text-2xl font-bold text-white">{manufacturer.charAt(0)}</span>
                  </div>
                  <h3 className="text-2xl font-bold text-white mb-2">{manufacturer}</h3>
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-gray-700 rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-2xl font-bold text-white">${data.basePrice}</span>
                    </div>
                    <p className="text-gray-400 text-sm">5-30 minute delivery</p>
                  </div>
                  
                  <div className="bg-blue-900/30 border border-blue-500/30 rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      <span className="text-blue-300">Rush</span>
                      <span className="text-2xl font-bold text-blue-400">${data.rushPrice}</span>
                    </div>
                ...
                {/* Popular Models */}
                <div className="mb-6">
                  <h4 className="text-white font-semibold mb-3">Popular Models</h4>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              Enhance your keycode request with premium services for faster delivery and expert support.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-300">
                Standard delivery takes 5-30 minutes. For urgent requests, our rush service 
                delivers within 2-4 hours for an additional fee.
              </p>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-300">
                Base pricing varies by manufacturer due to complexity and security features. 
                Some luxury brands may have higher costs due to advanced technology.
              </p>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-300">
                You'll need the vehicle's VIN, make, model, year, and proof of ownership 
                or professional credentials for verification.
              </p>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-300">
                Yes! For 100+ keycode requests, we offer significant discounts. Contact us 
                for custom bulk pricing tailored to your needs.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="py-16 bg-gradient-to-r from-blue-900 to-purple-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            No membership required. Get your keycode quickly and affordably with our 
            manufacturer-specific pricing. Start your request now!
          </p>
