    ...
    <div className="min-h-screen bg-gradient-to-br from-dark via-secondary to-dark p-8 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-2xl p-8 shadow-2xl">
          <h1 className="text-3xl font-bold text-white mb-8 text-center">User History</h1>
          <div className="mb-8">
          ...
          {isLoading ? (
              ...
              <table className="w-full bg-slate-800/50 border border-slate-600 rounded-xl overflow-hidden">
                <thead className="bg-slate-700/50">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-white font-semibold">Confirmation Number</th>
                  </tr>
                </thead>
                <tbody>
                  {history.map((transaction) => (
                    <tr key={transaction.id} className="border-t border-slate-600 hover:bg-slate-700/30 transition-colors duration-200">
                      <td className="px-6 py-4 text-white/80">{transaction.id}</td>
                      ...
                      <td className="px-6 py-4 text-white/80">{transaction.confirmationNumber}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
            ...
            <div className="text-center py-12">
              ...
              <p className="text-white/80 text-lg">No history found for this email.</p>
            </div>
          )}
        </div>
      </div>
