    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 border border-slate-700 rounded-xl p-6">
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-xl font-bold text-white">💳 Secure Payment via Stripe</h3>
        </div>
...
function CartItem({ item, onRemove }) {
  ...
  return (
    <div className={`bg-slate-800/50 border border-slate-600 rounded-xl p-4 transition-all duration-300 ${isRemoving ? "opacity-50 scale-95" : "hover:bg-slate-700/50"}`}>
          ...
          <div className="text-right">
            <div className="flex items-center gap-2">
              {item.standardPrice !== item.finalPrice && (
                <span className="text-white/50 line-through text-sm">${item.standardPrice}</span>
              )}
...
function SubscriptionCard({ tier, price, features, perks, onAdd, isDisabled }) {
  ...
  return (
    <div className={`bg-gradient-to-br from-slate-800/50 to-slate-900/50 border ${styles.borderColor} rounded-2xl p-6 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300`}>
      <div className="flex items-center gap-4 mb-6">
        <div className={`w-12 h-12 bg-gradient-to-r ${styles.iconBg} border ${styles.borderColor} rounded-xl flex items-center justify-center`}>
        ...
        <div>
          ...
          <p className={`${styles.priceColor} font-bold text-lg`}>${price}/month</p>
        </div>
      </div>
