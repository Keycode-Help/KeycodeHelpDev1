    ...
    if (user && hasAdminAccess) {
      const fetchData = async () => {
        try {
          ...
          if (error.response?.status === 403) {
            setError("Access denied. Your admin privileges may have been revoked.");
              ...
              {pendingUsers.length === 0 ? (
                ...
                <div className="space-y-6">
                  {pendingUsers.map((user) => (
                    <div
                      key={user.id}
                      className="bg-gradient-to-br from-slate-800/80 to-slate-900/80 backdrop-blur-sm border border-slate-600/50 rounded-3xl p-8 hover:border-slate-500/70 transition-all duration-300 shadow-2xl hover:shadow-3xl hover:scale-[1.02]"
                    >
                      {/* User Header */}
                      <div className="flex items-start justify-between gap-6 mb-6">
                        <div className="flex-1">
                          ...
                          <div className="space-y-6 mb-8">
                            {/* Email - Full Width */}
                            <div className="bg-gradient-to-r from-slate-800/60 to-slate-700/60 rounded-3xl p-6 border border-slate-600/50 shadow-lg">
