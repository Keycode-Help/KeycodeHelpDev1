            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div>
                <label className="block text-sm font-semibold text-white mb-3">
                  ...
                  <span className="text-xs text-slate-400 ml-2">({availableMakes.length} available)</span>
                </label>
                <MakeDropDown
              ...
              <div>
                <label className="block text-sm font-semibold text-white mb-3">
                  ...
                  <span className="text-xs text-slate-400 ml-2">({availableModels.length} available)</span>
                </label>
                <ModelDropDown
              ...
              <div>
                <label className="block text-sm font-semibold text-white mb-3">
                  ...
                  <span className="text-xs text-slate-400 ml-2">({availableYears.length} available)</span>
                </label>
                <YearDropDown
