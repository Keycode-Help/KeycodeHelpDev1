              ...
              {pendingUsers.length === 0 ? (
                ...
                <div className="space-y-6">
                  {pendingUsers.map((user) => (
                    <div
                      key={user.id}
                      className="bg-white rounded-3xl p-8 mb-6 shadow-xl border border-gray-200 hover:shadow-2xl transition-all duration-300"
                    >
                      {/* User Header */}
                      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6 mb-8">
                          ...
                          <div className="space-y-6 mb-8">
                            ...
                            <div className="bg-gray-50 rounded-2xl p-6 border border-gray-200">
                              <div className="flex items-center gap-3 mb-4">
                                ...
                                <span className="text-gray-700 text-sm font-semibold uppercase tracking-wide">
                                  Email Address
                                </span>
                              </div>
                              <p className="text-gray-800 font-semibold text-lg break-all leading-relaxed">
                                {user.email}
                              </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                              <div className="bg-gray-50 rounded-2xl p-4 border border-gray-200">
                                ...
                                <p className="text-gray-800 font-semibold text-sm break-all leading-relaxed">
                              ...
                              <div className="bg-gray-50 rounded-2xl p-4 border border-gray-200 sm:col-span-2 lg:col-span-1">
                                <div className="flex items-center gap-2 mb-3">
                        ...
                        <div className="flex flex-col sm:flex-row lg:flex-col gap-3 w-full sm:w-auto lg:w-full">
                          <button
                            ...
                            className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-3 rounded-xl font-semibold hover:from-green-600 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2 text-sm"
                          >
                      ...
                      <div className="border-t border-gray-200 pt-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                          {user.frontId && (
                            <div className="group">
                              <div className="bg-gray-50 rounded-2xl p-4 border border-gray-200 hover:border-gray-300 transition-all duration-300 shadow-lg hover:shadow-xl">
                                <img
                                  src={user.frontId}
                                  alt="Front ID"
                                  className="w-full h-40 object-cover rounded-xl border border-gray-200 group-hover:border-gray-300 cursor-pointer transition-colors duration-200"
                                  onClick={() => openModal(user.frontId)}
                                />
                                <p className="text-gray-700 text-sm text-center mt-3 font-semibold">
                                  Front ID
                                </p>
                              </div>
                            </div>
                        ...
                        {!user.frontId && !user.backId && !user.insurance && (
                          <div className="text-center py-8">
                            <div className="w-16 h-16 mx-auto mb-4 bg-gradient-to-r from-gray-200 to-gray-300 border border-gray-300 rounded-xl flex items-center justify-center">
