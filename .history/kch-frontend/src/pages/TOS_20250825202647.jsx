...
import { FileText, CheckCircle, XCircle, AlertTriangle, Shield, Users, Mail, Phone, Globe } from "lucide-react";
        ...
        <div className="policy-content">
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <p>
                By using KeycodeHelp, you agree to these simple terms. We provide vehicle keycode services 
                and expect you to use them responsibly.
              </p>
            </div>
          </section>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <ul>
                ...
                <li>Use our service for personal or business vehicle information</li>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <p>
                <strong>No refunds for user mistakes:</strong> If you enter wrong vehicle information, 
                submit duplicate requests, or change your mind, we cannot provide refunds.
              </p>
              <p>
                <strong>Refunds only for:</strong> Service failures, no keycode available, or technical 
                issues on our end.
              </p>
              <p>
                <strong>Membership cancellation:</strong> Cancel anytime. Monthly plans: no partial refunds. 
                Annual plans: prorated refunds for unused months.
              </p>
            </div>
          </section>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <p>
                Questions about these terms? We're here to help! Contact us anytime.
              </p>
            </div>
          </section>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <p>
                This is a simplified version of our Terms of Service. For the complete legal document 
                with all details and legal language, please read our full Terms of Service.
              </p>
              <p>
