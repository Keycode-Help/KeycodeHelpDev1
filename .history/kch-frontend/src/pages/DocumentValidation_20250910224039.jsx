      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Document Validation</h1>
              <p className="text-white/70">
                  ...
                  >
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <div className={`text-xs px-2 py-1 rounded-full ${
                        ...
                        {u.isValidatedUser === true ? "Verified" : 
                         u.isValidatedUser === false ? "Pending" : "Unknown"}
                      </div>
                    </div>
                    <div className="text-white/70 text-sm">{u.email}</div>
                    <div className="text-white/50 text-xs mt-1">
                      {[u.frontId, u.backId, u.insurance].filter(Boolean).length} documents
                    </div>
                  </button>
                ))}
              </div>
          ...
          <section className="lg:col-span-2 bg-slate-800/50 rounded-2xl p-6 border border-slate-600">
            {!selectedUserId ? (
              <div className="text-center py-12">
                ...
                <p className="text-white/70 text-lg">Select a user to view their documents</p>
              ...
              <div className="space-y-6">
                <div className="flex items-center justify-between">
                  <h2 className="text-xl font-semibold text-white">
                    Documents for {users.find(u => u.id === selectedUserId)?.fname} {users.find(u => u.id === selectedUserId)?.lname}
                  </h2>
                  <button
                    ...
                    >
                      ...
                      {d.storageKey && (
                        <div className="mb-3">
                          ...
                          />
                          <div className="hidden w-full h-32 bg-slate-700/50 rounded-lg border border-slate-600 flex items-center justify-center">
