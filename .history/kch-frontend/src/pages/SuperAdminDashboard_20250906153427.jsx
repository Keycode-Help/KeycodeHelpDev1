...
function SuperAdminDashboard() {
  ...
  const handleTrialApproval = async (adminId, notes) => {
    try {
      await api.post("/admin-approval/trial-approve", {
        superAdminEmail: user.email,
        adminId: String(adminId),
        approvalNotes: notes || "Trial approved by super admin - 3 days access",
      });
      alert("Trial approval granted! User will have 3 days of access.");
      setActionLog((l) => [
        { t: Date.now(), msg: `Trial approved admin ID ${adminId}` },
        ...l,
      ]);
      fetchAdminData();
    } catch (error) {
      console.error("Error granting trial approval:", error);
      alert("Failed to grant trial approval");
    }
  };
          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
              <div className="flex items-center gap-2">
                <span className="text-white/60 w-16">Email:</span>
                <span className="text-white truncate">{admin.email}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-white/60 w-16">Phone:</span>
                <span className="text-white">{admin.phone || "—"}</span>
              </div>
              <div className="flex items-center gap-2 sm:col-span-2">
                <span className="text-white/60 w-16">Company:</span>
                <span className="text-white">{admin.company || "—"}</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="text-white/60 w-16">Status:</span>
                <span
          ...
          <div className="mt-6 space-y-4">
            <div>
              ...
              <textarea
                ...
                className="w-full bg-white/10 border border-white/20 rounded-xl text-white placeholder-gray-600 p-3 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all resize-none"
                rows={3}
              />
            </div>
            <div className="flex gap-3">
              ...
              <button
                onClick={() => handleTrialApproval(admin.id, notes)}
                className="flex-1 inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-4 py-3 font-semibold transition-all duration-200 shadow-lg hover:shadow-blue-500/25 hover:-translate-y-0.5"
              >
                <Shield className="h-5 w-5" /> Trial Approval
              </button>
              <button
  ...
  if (loading) {
    return (
      <div className="mx-auto max-w-6xl px-4 md:px-6 py-10">
        <div className="text-center text-white/70">Loading admin data...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark via-secondary to-dark relative">
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex-1">
                    ...
                    <input
                      ...
                      className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                    />
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div className="space-y-4">
                  <input
                    ...
                    className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:border-transparent transition-all"
                    required
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <div className="md:col-span-2 lg:col-span-1">
                  ...
                  <input
                    ...
                    className="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-3 text-white placeholder-gray-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition-all"
                    required
                  />
                </div>
                <div>
              ...
              <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-xl">
                ...
                {approvedAdmins.filter((f) => {
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-white/60 text-lg">No approved admins</p>
                    <p className="text-white/50 text-sm mt-2">
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-xl">
              ...
              {actionLog.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-white/60 text-lg">No actions yet</p>
                  <p className="text-white/50 text-sm mt-2">
