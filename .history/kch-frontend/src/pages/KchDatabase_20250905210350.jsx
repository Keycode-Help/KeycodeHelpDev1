...
const KchDatabase = () => {
              ...
              <div>
                ...
                <div className="space-y-2">
                  {entry.notes.map((note, index) => (
                    <p
                      key={index}
                      className="text-sm text-white/70 bg-slate-700/30 rounded-lg p-3"
                    >
                      {note.text}
                    </p>
                  ))}
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark via-secondary to-dark p-4 lg:p-8 font-sans relative overflow-hidden">
      {/* Background Effects */}
          ...
          <button
            ...
            className={`flex items-center gap-3 px-6 py-4 rounded-2xl font-semibold cursor-pointer transition-all duration-300 transform hover:scale-105 ${
              showFilters
                ...
                : "bg-gradient-to-r from-slate-700/80 to-slate-800/80 text-white/70 hover:text-white hover:bg-slate-600/80 border-2 border-slate-600/50 hover:border-blue-500/50"
            } shadow-lg`}
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
              ...
              <div className="flex flex-col gap-2">
                ...
                <input
                  ...
                  className="p-3 bg-slate-800/50 border-2 border-slate-600 rounded-xl text-sm transition-all duration-300 focus:outline-none focus:border-blue-500 text-white shadow-sm placeholder-gray-600"
                  placeholder="1990"
                />
              </div>
