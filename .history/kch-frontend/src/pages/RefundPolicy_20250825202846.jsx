        ...
        <div className="policy-content">
          <section className="policy-section">
            ...
            <div className="policy-card warning-card">
              ...
              <p className="warning-text">
                <strong>
                  KeycodeHelp does not provide refunds for mistakes, incorrect
                  inputs, or user errors.
                </strong>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <ul>
                <li>
                  <strong>Vehicle Information Mistakes:</strong> Incorrect make,
                  model, year, or VIN
                </li>
                <li>
                  <strong>Data Entry Errors:</strong> Typos, wrong numbers, or
                ...
                <li>
                  <strong>User Confusion:</strong> Not understanding the service
                  or process
                </li>
                <li>
                  <strong>Change of Mind:</strong> Deciding you don't need the
                  service after purchase
                </li>
                <li>
                  <strong>Technical User Issues:</strong> Browser problems, slow
                  internet, or device issues
                </li>
                <li>
                  <strong>Incorrect Vehicle Selection:</strong> Choosing wrong
                  vehicle from search results
                </li>
                <li>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <p>
                Refunds are only provided in the following specific
                circumstances:
              </p>
              ...
              <div className="refund-scenario">
                ...
                <p>
                  <strong>Full Refund:</strong> If we cannot provide a keycode
                  for your vehicle after processing your request, you will
                  receive a full refund.
                </p>
                <ul>
                  <li>Vehicle not found in our database</li>
                  <li>
                    Keycode information unavailable for your specific model
                  </li>
              ...
              <div className="refund-scenario">
                ...
                <p>
                  <strong>Full Refund:</strong> If our service is completely
                  unavailable or fails to process your request due to technical
                  issues on our end.
                </p>
                <ul>
                  <li>System downtime exceeding 24 hours</li>
                  <li>
                    Complete service failure preventing request processing
                  </li>
              ...
              <div className="refund-scenario">
                ...
                <p>
                  <strong>Full Refund:</strong> If payment is processed but
                  service is not provided due to technical errors on our end.
                </p>
                <ul>
              ...
              <div className="refund-process">
                <div className="process-step">
                  ...
                  <div className="step-content">
                    ...
                    <p>
                      Contact our support team with your order details and
                      reason for refund
                    </p>
                  </div>
                </div>
                ...
                <div className="process-step">
                  ...
                  <div className="step-content">
                    ...
                    <p>
                      You will be notified of approval or denial with
                      explanation
                    </p>
                  </div>
                </div>
            ...
            <div className="policy-card">
              ...
              <div className="timeline-info">
                <div className="timeline-item">
                  <h4>Review Period</h4>
                  <p>
                    <strong>2-3 business days</strong> for initial review
                  </p>
                </div>
                <div className="timeline-item">
                  <h4>Refund Processing</h4>
                  <p>
                    <strong>5-10 business days</strong> for payment processing
                  </p>
                </div>
                <div className="timeline-item">
                  <h4>Bank Processing</h4>
                  <p>
                    <strong>3-5 business days</strong> for funds to appear in
                    your account
                  </p>
                </div>
              </div>
              <p className="note">
                <strong>Total Time:</strong> 10-18 business days from approval
            ...
            <div className="policy-card">
              ...
              <div className="request-methods">
                <div className="method">
                  <h4>📧 Email Support</h4>
                  <p>
                    Send detailed request to:{" "}
                    <strong>refunds@keycodehelp.com</strong>
                  </p>
                ...
                <div className="method">
                  <h4>📞 Phone Support</h4>
                  <p>
                    Call: <strong>+1 (555) 123-4567</strong>
                  </p>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <p>
                KeycodeHelp reserves the right to modify this refund policy at
                any time. Changes will be communicated through email
                notifications and website updates. Continued use of our services
                after policy changes constitutes acceptance of the updated
                terms.
              </p>
            </div>
          </section>
