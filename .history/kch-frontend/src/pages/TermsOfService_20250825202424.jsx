...
import { FileText, AlertTriangle, CheckCircle, XCircle, Clock, DollarSign, Shield, Users, Mail, Phone, Globe } from "lucide-react";
        ...
        <div className="policy-content">
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <p>
                By accessing and using KeycodeHelp services, you agree to be bound by these Terms of Service.
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <p>
                KeycodeHelp provides vehicle keycode lookup and information services, including:
              </p>
              <ul>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <p>
                <strong>Important:</strong> KeycodeHelp does not provide refunds for:
              </p>
              <ul>
              ...
              <ul>
                <li><strong>No Keycode Available:</strong> If we cannot provide a keycode for your vehicle</li>
                <li><strong>Service Failure:</strong> If our service is completely unavailable</li>
                <li><strong>Technical Issues:</strong> If our system fails to process your request</li>
              </ul>
            </div>
          </section>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <ul>
                <li><strong>Monthly Memberships:</strong> Cancel anytime, no refund for partial months</li>
                <li><strong>Annual Memberships:</strong> Cancel anytime, prorated refund for unused months</li>
                <li><strong>Processing Time:</strong> Cancellations take effect at the end of current billing period</li>
                <li><strong>Access:</strong> Service access continues until the end of paid period</li>
                <li><strong>Reactivation:</strong> Can reactivate anytime with current pricing</li>
              </ul>
              <p>
                To cancel your membership, contact our support team or use the cancellation option in your account settings.
              </p>
            </div>
          </section>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <ul>
                ...
                <li>Vehicle data is provided under license from third parties</li>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <ul>
                ...
                <li>We are not responsible for third-party vehicle data accuracy</li>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <p>
                ...
                communicated through email or prominent website notice. Continued use after changes
