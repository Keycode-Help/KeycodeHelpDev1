      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-slate-800/50 rounded-2xl p-6 mb-6 border border-slate-600">
          <div className="flex flex-col gap-6">
            {/* Header */}
            <div className="flex items-center justify-between">
              <h2 className="text-xl font-semibold text-white">Filter & Search Users</h2>
              <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="space-y-2">
                <label htmlFor="search-users" className="block text-sm font-medium text-white/90">
                  Search Users
                </label>
              ...
              {/* Filter Type */}
              <div className="space-y-2">
                <label htmlFor="filter-type" className="block text-sm font-medium text-white/90">
                  User Status
                </label>
                <select
                  id="filter-type"
              ...
              {/* Sort Options */}
              <div className="space-y-2">
                <label htmlFor="sort-options" className="block text-sm font-medium text-white/90">
                  Sort By
                </label>
                <select
                  id="sort-options"
              ...
              <div className="flex flex-wrap items-center gap-2 pt-4 border-t border-slate-600">
                ...
                {filterType !== "all" && (
                  <span className="inline-flex items-center gap-1 px-3 py-1 bg-green-500/20 text-green-300 rounded-full text-sm">
                    Status: {filterType === "trial" ? "Trial Users" : 
                             filterType === "pro" ? "Pro Users" :
                             filterType === "pending" ? "Pending Approval" :
                             filterType === "inactive" ? "Inactive Users" : filterType}
                    <button
