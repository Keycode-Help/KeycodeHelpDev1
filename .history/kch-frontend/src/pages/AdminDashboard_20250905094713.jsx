                        ...
                        <div className="flex-1">
                          ...
                          <div className="space-y-6 mb-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                              <div className="bg-gradient-to-r from-slate-800/60 to-slate-700/60 rounded-2xl p-6 border border-slate-600/50 shadow-lg hover:shadow-xl transition-all duration-300">
                                <div className="flex items-center gap-3 mb-4">
                                ...
                                <p className="text-white font-semibold text-base break-all leading-relaxed">
                              ...
                              <div className="bg-gradient-to-r from-slate-800/60 to-slate-700/60 rounded-2xl p-6 border border-slate-600/50 shadow-lg hover:shadow-xl transition-all duration-300 md:col-span-2 xl:col-span-1">
                                <div className="flex items-center gap-3 mb-4">
