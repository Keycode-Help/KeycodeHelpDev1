      ...
      <div className="payment-cancel-container">
        ...
        <div className="what-happened">
          ...
          <div className="explanation">
            ...
            <p>
              <strong>Good news:</strong> No money was charged to your account,
