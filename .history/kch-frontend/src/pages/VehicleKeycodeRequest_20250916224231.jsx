          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {selectedMake && isVehicleNotAvailable && (
              <div className="bg-gradient-to-r from-red-500/10 to-orange-500/10 border border-red-500/30 rounded-xl p-6">
                <div className="flex items-center gap-3">
                  <Icon name="alertTriangle" size={24} className="text-red-400 flex-shrink-0" />
                  <div>
                    <h3 className="text-xl font-semibold text-red-400 mb-2">
                      {selectedMake} - Keycodes Not Available
                    </h3>
                    <p className="text-red-300">
                      {availabilityNote || "Keycodes for this vehicle brand are not currently available."}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-yellow-300">
                      {availabilityNote || "Limited keycode availability for this brand. Please contact support for specific models."}
                    </p>
                  </div>
                </div>
              </div>
            ...
            >
              <Icon name={isVehicleNotAvailable ? "x" : "shoppingCart"} size={18} />
              {isVehicleNotAvailable 
                ? "Not Available" 
                : hasLimitedStock 
