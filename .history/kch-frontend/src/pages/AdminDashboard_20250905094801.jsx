...
function AdminDashboard() {
  ...
  const fetchValidatedUsers = useCallback(() => {
    api
      ...
      .then((response) => setValidatedUsers(response.data || []))
      .catch((error) => {
        ...
        <div className="mb-10 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-2">
                ...
                <input
                  ...
                  className="w-full bg-slate-800/50 border border-slate-600 text-white rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 placeholder-gray-400"
                />
              </div>
              <div className="space-y-2">
          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-700 rounded-3xl p-6 shadow-xl">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="bg-gradient-to-br from-yellow-500/10 to-orange-500/10 border border-yellow-500/20 rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="bg-gradient-to-br from-orange-500/10 to-red-500/10 border border-orange-500/20 rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="bg-gradient-to-br from-blue-500/10 to-cyan-500/10 border border-blue-500/20 rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              <div className="bg-gradient-to-br from-emerald-500/10 to-green-500/10 border border-emerald-500/20 rounded-2xl p-6 text-center shadow-lg hover:shadow-xl transition-all duration-300">
              ...
              {pendingUsers.length === 0 ? (
                ...
                <div className="space-y-6">
                  {pendingUsers.map((user) => (
                    <div
                      key={user.id}
                      className="bg-gradient-to-br from-purple-900/90 to-blue-900/90 backdrop-blur-sm border-2 border-purple-500/50 rounded-3xl p-8 hover:border-purple-400/70 transition-all duration-300 shadow-2xl hover:shadow-3xl hover:scale-[1.02]"
                    >
                      {/* User Header */}
                      <div className="flex items-start justify-between gap-6 mb-6">
                        <div className="flex-1">
                          <div className="flex items-center gap-4 mb-4">
                            <div className="w-12 h-12 bg-gradient-to-r from-blue-500/20 to-purple-500/20 border border-blue-500/30 rounded-2xl flex items-center justify-center">
                          ...
                          <div className="space-y-6 mb-8">
                            {/* Email - Full Width */}
                            <div className="bg-gradient-to-r from-emerald-800/80 to-teal-800/80 rounded-3xl p-6 border-2 border-emerald-500/50 shadow-xl">
                              ...
                              <p className="text-white font-bold text-xl break-all leading-relaxed">
                                {user.email}
                              </p>
                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                              <div className="bg-gradient-to-r from-blue-800/80 to-indigo-800/80 rounded-2xl p-6 border-2 border-blue-500/50 shadow-lg hover:shadow-xl transition-all duration-300">
                                <div className="flex items-center gap-3 mb-4">
                                ...
                                <p className="text-white font-bold text-base break-all leading-relaxed">
                                  {user.phone || "Not provided"}
                                </p>
                              </div>

                              <div className="bg-gradient-to-r from-orange-800/80 to-red-800/80 rounded-2xl p-6 border-2 border-orange-500/50 shadow-lg hover:shadow-xl transition-all duration-300">
                                <div className="flex items-center gap-3 mb-4">
                                  <div className="w-3 h-3 bg-orange-400 rounded-full shadow-lg"></div>
                                  <span className="text-orange-200 text-sm font-bold uppercase tracking-wider">
                                    State
                                  </span>
                                </div>
                                <p className="text-white font-bold text-base break-all leading-relaxed">
                              ...
                              <div className="bg-gradient-to-r from-purple-800/80 to-pink-800/80 rounded-2xl p-6 border-2 border-purple-500/50 shadow-lg hover:shadow-xl transition-all duration-300 md:col-span-2 xl:col-span-1">
                                <div className="flex items-center gap-3 mb-4">
                                  <div className="w-3 h-3 bg-purple-400 rounded-full shadow-lg"></div>
                                  <span className="text-purple-200 text-sm font-bold uppercase tracking-wider">
                                    Industry
                                  </span>
                                </div>
                                <p className="text-white font-bold text-base break-all leading-relaxed">
                        ...
                        <div className="flex flex-col sm:flex-row lg:flex-col gap-3 min-w-[160px]">
                          <button
                            ...
                            className="bg-gradient-to-r from-emerald-500 to-green-500 text-white px-6 py-4 rounded-2xl font-bold hover:from-emerald-600 hover:to-green-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-slate-900 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-3 text-sm hover:scale-105"
                          >
                          ...
                          <button
                            ...
                            className="bg-gradient-to-r from-red-500 to-pink-500 text-white px-6 py-4 rounded-2xl font-bold hover:from-red-600 hover:to-pink-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 focus:ring-offset-slate-900 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-3 text-sm hover:scale-105"
                          >
                      ...
                      <div className="border-t border-slate-600/50 pt-6">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                          {user.frontId && (
                            <div className="group">
                              <div className="bg-gradient-to-r from-slate-800/60 to-slate-700/60 rounded-2xl p-4 border border-slate-600/50 hover:border-slate-500/70 transition-all duration-300 shadow-lg hover:shadow-xl">
                                <img
                                  src={user.frontId}
                                  alt="Front ID"
                                  className="w-full h-48 object-cover rounded-xl border border-slate-600 group-hover:border-slate-500 cursor-pointer transition-colors duration-200"
