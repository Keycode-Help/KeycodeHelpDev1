    ...
    if (plan?.isTrial) {
      try {
        ...
        if (error.response?.status === 401 || error.response?.status === 403) {
          console.log("🚨 Authentication error in subscription, redirecting to login...");
        ...
        // Handle other errors
        console.log("⚠️ Subscription API error, falling back to trial explainer page");
        toast.error("Unable to process subscription. Redirecting to trial information.");
