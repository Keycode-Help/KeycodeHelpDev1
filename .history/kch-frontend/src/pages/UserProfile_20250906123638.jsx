      ...
      <div className="max-w-6xl mx-auto mb-8">
          ...
          <div className="bg-amber-500/10 border border-amber-500/20 rounded-xl p-6 mb-8">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1">
                <h3 className="text-amber-400 font-semibold text-lg mb-4">Important Notices</h3>
                <div className="space-y-4">
                  {importantNotices.map((notice, index) => (
                    <div key={index} className="bg-slate-800/50 rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        <span className="font-medium text-white">{notice.title}</span>
                        <span className="text-amber-300 text-sm">{formatDate(notice.date)}</span>
                      </div>
        ...
        {activeTab === "profile" && (
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8">
            ...
            <div className="mb-8">
              <h2 className="text-2xl font-semibold text-white mb-6">Profile Photos</h2>
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-slate-700/50 border-2 border-dashed border-slate-600 rounded-xl p-8 text-center hover:border-blue-500 transition-colors duration-200 cursor-pointer">
                      {profileData.profilePhoto ? (
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <span className="text-slate-300 font-medium">Profile Photo</span>
                        </div>
                      )}
                    </div>
                    <input
                  ...
                  <p className="text-sm text-slate-400 text-center">Click to upload profile photo</p>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-slate-700/50 border-2 border-dashed border-slate-600 rounded-xl p-8 text-center hover:border-blue-500 transition-colors duration-200 cursor-pointer">
                      {profileData.companyLogo ? (
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <span className="text-slate-300 font-medium">Company Logo</span>
                        </div>
                      )}
                    </div>
                    <input
                  ...
                  <p className="text-sm text-slate-400 text-center">Click to upload company logo</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              {/* Company Information */}
              <div className="space-y-2">
                <label className="block text-sm font-semibold text-white">Company</label>
                <input
                  type="text"
