            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  required
                  className={`w-full px-4 py-3 bg-slate-800/50 border rounded-xl [color:#000000!important] placeholder-gray-600 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 ${
                    errors.fname
