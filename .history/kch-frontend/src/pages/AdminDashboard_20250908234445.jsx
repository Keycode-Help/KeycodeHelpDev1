...
function AdminDashboard() {
  ...
  const testBase64Image = (base64String) => {
    ...
    if (base64String.length > 1024 * 1024) {
      console.log("⚠️ Base64 image is very large (" + Math.round(base64String.length / 1024) + "KB), may cause performance issues");
    }
                          ...
                          <div className="group">
                            <div className="bg-slate-800/50 rounded-2xl p-4 border border-slate-600 hover:border-slate-500 transition-all duration-300 shadow-lg hover:shadow-xl">
                              <img
                                ...
                                onError={(e) => handleImageError(e, "Front ID", user.frontId)}
                                onLoad={() => {
                                  console.log(
                              ...
                              <div className="hidden w-full h-40 bg-slate-700/50 rounded-xl border border-slate-600 flex items-center justify-center">
                                <div className="text-center">
                                  ...
                                  <p className="text-white/20 text-xs">
                                    {user.frontId && user.frontId.length > 1024 * 1024 
                                      ? "Image too large (" + Math.round(user.frontId.length / 1024) + "KB)"
