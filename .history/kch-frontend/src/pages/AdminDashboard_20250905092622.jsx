              ...
              {pendingUsers.length === 0 ? (
                ...
                <div className="space-y-6">
                  {pendingUsers.map((user) => (
                    <div
                      key={user.id}
                      className="bg-gradient-to-br from-slate-700/30 to-slate-800/30 backdrop-blur-sm border border-slate-600 rounded-3xl p-8 hover:border-slate-500 transition-all duration-300 shadow-xl hover:shadow-2xl"
                    >
                      {/* User Header */}
                      <div className="flex items-start justify-between gap-6 mb-6">
                            ...
                            <div className="space-y-3">
                              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-600/50">
                                <div className="flex items-center gap-2 mb-2">
                                  ...
                                  <span className="text-gray-400 text-sm font-semibold uppercase tracking-wide">Email</span>
                                </div>
                              ...
                              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-600/50">
                                <div className="flex items-center gap-2 mb-2">
                                  ...
                                  <span className="text-gray-400 text-sm font-semibold uppercase tracking-wide">Phone</span>
                                </div>
                            ...
                            <div className="space-y-3">
                              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-600/50">
                                <div className="flex items-center gap-2 mb-2">
                                  ...
                                  <span className="text-gray-400 text-sm font-semibold uppercase tracking-wide">State</span>
                                </div>
                                <p className="text-white font-medium">{user.state || "Not provided"}</p>
                              </div>
                              
                              <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-600/50">
                                <div className="flex items-center gap-2 mb-2">
                                  <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                                  <span className="text-gray-400 text-sm font-semibold uppercase tracking-wide">Industry</span>
                                </div>
                                <p className="text-white font-medium">{user.industry || "Not specified"}</p>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex flex-col gap-3 min-w-[140px]">
                          <button
                            ...
                            className="bg-gradient-to-r from-emerald-500 to-green-500 text-white px-6 py-3 rounded-2xl font-bold hover:from-emerald-600 hover:to-green-600 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2 focus:ring-offset-slate-900 transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-3 text-sm"
                          >
                      ...
                      <div className="border-t border-slate-600/50 pt-6">
                        <div className="flex items-center gap-3 mb-4">
                          ...
                          <h4 className="text-white font-semibold text-lg">Supporting Documents</h4>
                        </div>
                        
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                          {user.frontId && (
                            <div className="group">
                              <div className="bg-slate-800/50 rounded-xl p-3 border border-slate-600/50 hover:border-slate-500 transition-all duration-300">
                                <img
                                  src={user.frontId}
                                  alt="Front ID"
                                  className="w-full h-32 object-cover rounded-lg border border-slate-600 group-hover:border-slate-500 cursor-pointer transition-colors duration-200"
                                  onClick={() => openModal(user.frontId)}
                                />
                                <p className="text-gray-400 text-xs text-center mt-2 font-medium">Front ID</p>
                              </div>
                            </div>
                          )}
                          {user.backId && (
                            <div className="group">
                              <div className="bg-slate-800/50 rounded-xl p-3 border border-slate-600/50 hover:border-slate-500 transition-all duration-300">
                                ...
                                />
                                <p className="text-gray-400 text-xs text-center mt-2 font-medium">Back ID</p>
                              </div>
                            </div>
                          )}
                          {user.insurance && (
                            <div className="group">
                              <div className="bg-slate-800/50 rounded-xl p-3 border border-slate-600/50 hover:border-slate-500 transition-all duration-300">
                                ...
                                />
                                <p className="text-gray-400 text-xs text-center mt-2 font-medium">Insurance</p>
                              </div>
                            </div>
                          )}
                        </div>
                        ...
                        {!user.frontId && !user.backId && !user.insurance && (
                          <div className="text-center py-8">
                            ...
                            <p className="text-gray-400">No supporting documents uploaded</p>
                          </div>
                        )}
                      </div>
                    </div>
