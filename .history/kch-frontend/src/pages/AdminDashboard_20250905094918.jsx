              ...
              {pendingUsers.length === 0 ? (
                ...
                <div className="space-y-6">
                  {pendingUsers.map((user) => (
                    <div
                      key={user.id}
                      className="bg-slate-800/90 backdrop-blur-sm border border-slate-600 rounded-3xl p-12 hover:border-slate-500 transition-all duration-300 shadow-xl hover:shadow-2xl"
                    >
                      {/* User Header */}
