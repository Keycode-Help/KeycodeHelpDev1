...
const KeycodePortals = () => {
  ...
  useEffect(() => {
    ...
    if (user && user.role && allowedRoles.includes(userRoleLower)) {
      console.log("User authorized, loading portals data");
      // Load portals data
      loadPortalsData();
    }
  ...
  const loadPortalsData = async () => {
    try {
      setLoading(true);
      const response = await fetch("/keycode-portals.json");
      if (!response.ok) {
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-white/70">Loading keycode portals...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-300">
            Keycode portals configuration could not be loaded.
          </p>
        </div>
      </div>
    );
      ...
      <div className="bg-slate-800/50 shadow-sm border-b border-slate-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-white">Keycode Portals</h1>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-yellow-300">
                <p>
                  To access these OEM keycode portals, you <strong>MUST</strong>{" "}
                  download the Authy app for two-factor authentication. Many
                  portals require 2FA for security compliance.
                </p>
