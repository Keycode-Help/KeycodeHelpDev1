                          ...
                          <div className="space-y-6 mb-8">
                            ...
                            <div className="bg-slate-800/50 rounded-2xl p-6 border border-slate-600/50">
                              <div className="flex items-center gap-3 mb-4">
                                ...
                                <span className="text-gray-400 text-sm font-bold uppercase tracking-wider">Email Address</span>
                              </div>
                              <p className="text-white font-semibold text-lg break-all leading-relaxed">{user.email}</p>
                            </div>
                            
                            {/* Other Details - 3 Column Grid */}
                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                              <div className="bg-slate-800/50 rounded-2xl p-5 border border-slate-600/50">
                                <div className="flex items-center gap-2 mb-3">
                                  <div className="w-2 h-2 bg-green-400 rounded-full"></div>
                                  <span className="text-gray-400 text-xs font-bold uppercase tracking-wider">Phone</span>
                                </div>
                                <p className="text-white font-medium text-sm break-all leading-relaxed">{user.phone || "Not provided"}</p>
                              </div>
                              
                              <div className="bg-slate-800/50 rounded-2xl p-5 border border-slate-600/50">
                                <div className="flex items-center gap-2 mb-3">
                                  <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                                  <span className="text-gray-400 text-xs font-bold uppercase tracking-wider">State</span>
                                </div>
                                <p className="text-white font-medium text-sm break-all leading-relaxed">{user.state || "Not provided"}</p>
                              </div>
                              
                              <div className="bg-slate-800/50 rounded-2xl p-5 border border-slate-600/50">
                                <div className="flex items-center gap-2 mb-3">
                                  <div className="w-2 h-2 bg-purple-400 rounded-full"></div>
                                  <span className="text-gray-400 text-xs font-bold uppercase tracking-wider">Industry</span>
                                </div>
                                <p className="text-white font-medium text-sm break-all leading-relaxed">{user.industry || "Not specified"}</p>
                              </div>
                            </div>
                          </div>
                        </div>
