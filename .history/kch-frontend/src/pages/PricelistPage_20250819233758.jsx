      ...
      <div className="bg-gradient-to-r from-blue-900 to-purple-900 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Choose the perfect plan for your keycode needs. All plans include
            our comprehensive vehicle database and expert support team.
          </p>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-300 max-w-2xl mx-auto">
              Need something specific? We offer additional services to meet your
              unique requirements.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-300">
                Each keycode request includes access to our comprehensive
                vehicle database, expert analysis, and detailed documentation
            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-300">
                ...
                with our service, we'll refund your subscription fee, no
                questions asked.
              </p>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-300">
                ...
                Enterprise also includes phone support and a dedicated account
                manager.
              </p>
            </div>
          </div>
      ...
      <div className="py-16 bg-gradient-to-r from-blue-900 to-purple-900">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Join thousands of automotive professionals who trust KeyCode Help
            for their keycode needs. Start your free trial today!
          </p>
