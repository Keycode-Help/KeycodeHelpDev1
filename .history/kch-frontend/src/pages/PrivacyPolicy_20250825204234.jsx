          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <ul>
                ...
                <li>
                  <strong>Business Transfers:</strong> In case of company sale
                  or merger (with notice)
                </li>
              </ul>
            </div>
          </section>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <ul>
                ...
                <li>
                  <strong>Transaction Records:</strong> Kept for 7 years for tax
                  and legal purposes
                </li>
                <li>
          ...
          <section className="policy-section">
            ...
            <div className="policy-card">
              ...
              <p>
                ...
                practices, please contact us. We're committed to protecting your
                privacy and will respond to your inquiries promptly.
              </p>
            </div>
          </section>
        </div>
