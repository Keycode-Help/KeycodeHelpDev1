...
export default function LandingPage() {
  ...
  useEffect(() => {
    if (!token) return;
    axios
      .get("http://localhost:8080/keycode-user/subscription", {
      ...
      <main className="w-full px-4 md:px-8 py-12 space-y-16">
        ...
        <div className="bento-container bg-primary/10 border-primary/20">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 p-4">
            ...
            <Link
              ...
              className="btn-cta whitespace-nowrap flex items-center gap-2"
            >
        ...
        <section className="grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Link
                to="/vehicle-keycode-request"
                className="btn-cta animate-pulse flex items-center gap-2"
              >
        ...
        <section className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bento-item">
            ...
            <Link
              to="/vehicle-keycode-request"
              className="btn-cta w-full flex items-center gap-2 justify-center"
            >
