    ...
    <div className="mx-auto max-w-7xl px-4 md:px-6 py-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <section className="rounded-3xl border border-neutral-800 bg-black/30 p-5 backdrop-blur supports-[backdrop-filter]:bg-black/40">
          {!selectedUser ? (
            <div className="text-gray-600">Select a user to view details</div>
          ) : (
            <div className="space-y-3">
              ...
              {/* Notes */}
              <div>
                <label className="text-gray-600 text-sm flex items-center gap-2 mb-1">
              ...
              <div className="flex flex-wrap gap-2 mt-3">
                {selectedUser.frontId && (
                  <img
                    ...
                    onClick={() => openModal(getImageUrl(selectedUser.frontId))}
                  />
                )}
                {selectedUser.backId && (
                  <img
                    ...
                    alt="Back ID"
                    className="w-24 h-24 object-cover rounded-lg border border-neutral-700"
                    onClick={() => openModal(getImageUrl(selectedUser.backId))}
                  />
                )}
                {selectedUser.insurance && (
                  <img
                    ...
                    alt="Insurance"
                    className="w-24 h-24 object-cover rounded-lg border border-neutral-700"
                    onClick={() => openModal(getImageUrl(selectedUser.insurance))}
                  />
                )}
              </div>
            </div>
