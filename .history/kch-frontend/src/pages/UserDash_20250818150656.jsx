...
function UserDash() {
  ...
  return (
    <div className="mx-auto w-full max-w-6xl px-4 md:px-6 pb-16">
        ...
        (() => {
          const list =
            activeTab === "pending"
              ...
              : filtered.fulfilled;
          if (!list.length) {
            return <EmptyState title="Nothing here yet" subtitle="New requests will appear in this tab." />;
          }
          return (
      ...
      {modalImage && <ModalContent modalImage={modalImage} closeModal={closeModal} />}
    </div>
  );
}
