...
function AdminRegister() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark via-secondary to-dark flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 bg-surface/50 backdrop-blur-sm rounded-2xl shadow-2xl w-full max-w-2xl p-8 border border-secondary">
        <div className="text-center mb-8">
          <h2 className="text-4xl font-bold bg-gradient-to-r from-blue-400 to-yellow-400 bg-clip-text text-transparent mb-2 uppercase tracking-wide">
            Admin Registration
          </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label
                htmlFor="firstName"
                className="block text-sm font-semibold text-white/90 mb-2 uppercase tracking-wide"
              >
                First Name *
              </label>
              <input
                ...
                className={`w-full px-4 py-3 border-2 rounded-lg text-base transition-all duration-300 bg-surface/50 text-white placeholder-white/50 focus:outline-none focus:ring-0 focus:border-primary focus:shadow-lg focus:-translate-y-0.5 ${
                  errors.firstName
          ...
          <div>
            ...
            <div className="flex gap-3 items-start flex-wrap">
              <input
                ...
                className={`flex-1 min-w-48 px-4 py-3 border-2 rounded-lg text-base transition-all duration-300 bg-surface/50 text-white placeholder-white/50 focus:outline-none focus:ring-0 focus:border-primary focus:shadow-lg focus:-translate-y-0.5 ${
                  errors.adminCode
                    ? "border-red-500 focus:border-red-500"
                    : "border-secondary"
              ...
              <button
                ...
                className="px-4 py-3 bg-gradient-to-r from-primary to-primary-dark text-white rounded-lg font-semibold text-sm cursor-pointer transition-all duration-300 whitespace-nowrap min-w-32 hover:shadow-lg hover:-translate-y-0.5 disabled:opacity-60 disabled:cursor-not-allowed disabled:transform-none"
              >
                {codeRequestLoading
                  ? "Sending..."
                  : codeRequested
            ...
            <small className="mt-2 text-sm text-white/60 italic block">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className={`w-full px-4 py-3 pr-12 border-2 rounded-lg text-base transition-all duration-300 bg-surface/50 text-white placeholder-white/50 focus:outline-none focus:ring-0 focus:border-primary focus:shadow-lg focus:-translate-y-0.5 ${
                    errors.password
                      ? "border-red-500 focus:border-red-500"
                      : "border-secondary"
                  }`}
                ...
                <button
                  ...
                  className="absolute right-3 top-1/2 transform -translate-y-1/2 text-white/60 hover:text-white transition-colors duration-200 p-1"
          ...
          <button
            type="submit"
            className="w-full py-4 bg-gradient-to-r from-primary to-primary-dark text-white rounded-lg font-semibold text-lg uppercase tracking-wide cursor-pointer transition-all duration-300 mt-6 hover:shadow-xl hover:-translate-y-1 relative overflow-hidden group"
          >
        ...
        <div className="mt-8 text-center">
          <p className="text-white/70">
            ...
            <a
              href="/admin-login"
              className="text-primary font-semibold hover:text-primary-light transition-colors duration-300 hover:underline"
            >
              Login here
            </a>
          </p>
