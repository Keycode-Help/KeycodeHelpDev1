    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4">
      ...
      <div className="max-w-6xl mx-auto mb-8">
        ...
        {activeTab === "credentials" && (
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8">
            <div className="space-y-6">
              <h3 className="text-2xl font-semibold text-white mb-6">Business Credentials & Files</h3>
                  ...
                  <label htmlFor="business-license" className="block">
                    <div className="bg-slate-700/50 border-2 border-dashed border-slate-600 rounded-xl p-6 text-center hover:border-blue-500 transition-colors duration-200 cursor-pointer">
                      <div className="flex flex-col items-center">
                        ...
                        <span className="text-slate-300 font-medium mb-2">Business License</span>
                        {credentials.businessLicense && (
                ...
                <div className="space-y-4">
                  <label htmlFor="drivers-license-front" className="block">
                    <div className="bg-slate-700/50 border-2 border-dashed border-slate-600 rounded-xl p-6 text-center hover:border-blue-500 transition-colors duration-200 cursor-pointer">
                      <div className="flex flex-col items-center">
                        <FileText size={32} className="text-slate-400 mb-3" />
                        <span className="text-slate-300 font-medium mb-2">Driver's License - Front</span>
                        {credentials.driversLicenseFront && (
                          <CheckCircle size={20} className="text-green-400" />
                        )}
                      </div>
                ...
                <div className="space-y-4">
                  <label htmlFor="drivers-license-back" className="block">
                    <div className="bg-slate-700/50 border-2 border-dashed border-slate-600 rounded-xl p-6 text-center hover:border-blue-500 transition-colors duration-200 cursor-pointer">
                      <div className="flex flex-col items-center">
                        <FileText size={32} className="text-slate-400 mb-3" />
                        <span className="text-slate-300 font-medium mb-2">Driver's License - Back</span>
                        {credentials.driversLicenseBack && (
                          <CheckCircle size={20} className="text-green-400" />
                        )}
                      </div>
                ...
                <div className="space-y-4">
                  <label htmlFor="insurance-certificate" className="block">
                    <div className="bg-slate-700/50 border-2 border-dashed border-slate-600 rounded-xl p-6 text-center hover:border-blue-500 transition-colors duration-200 cursor-pointer">
                      <div className="flex flex-col items-center">
                        <FileText size={32} className="text-slate-400 mb-3" />
                        <span className="text-slate-300 font-medium mb-2">Insurance Certificate</span>
                        {credentials.insuranceCertificate && (
                          <CheckCircle size={20} className="text-green-400" />
                        )}
                      </div>
              ...
              {uploadSuccess && (
                <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-4">
                  <div className="flex items-center gap-3">
                    <CheckCircle size={20} className="text-green-400" />
                    <span className="text-green-200">Documents uploaded successfully!</span>
                  </div>
                </div>
              )}
              ...
              {credentials.identificationDocuments && credentials.identificationDocuments.length > 0 && (
                <div className="bg-slate-700/50 border border-slate-600 rounded-xl p-6">
                  ...
                  <div className="space-y-3">
                    {credentials.identificationDocuments.map((doc, index) => (
                      <div key={index} className="flex items-center gap-3 p-3 bg-slate-800/50 rounded-lg">
                        ...
                        <span className="text-slate-300 flex-1">{doc.name}</span>
        ...
        {activeTab === "security" && (
          <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700 rounded-xl p-8">
            <div className="space-y-6">
              <h3 className="text-2xl font-semibold text-white mb-6">Security Settings</h3>
                ...
                <div className="bg-slate-700/50 border border-slate-600 rounded-xl p-6">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="text-lg font-semibold text-white">Fingerprint Authentication</h4>
                        <p className="text-slate-300 text-sm">Use your fingerprint to access profile changes</p>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-300 text-sm">Add an extra layer of security with 2FA</p>
                      </div>
                    </div>
                    <label className="relative inline-flex items-center cursor-pointer">
                      <input
              ...
              <div className="bg-slate-700/50 border border-slate-600 rounded-xl p-6">
                <h4 className="text-lg font-semibold text-white mb-4">Security Information</h4>
                <div className="space-y-4">
                  <div className="flex items-center justify-between py-2">
                    <span className="text-slate-300">Last Login:</span>
                    <span className="text-white font-medium">{formatDate(securitySettings.lastLogin)}</span>
                  </div>
                  <div className="flex items-center justify-between py-2">
      ...
      {showFingerprintModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 max-w-md w-full">
            <h3 className="text-xl font-semibold text-white mb-4">Enable Fingerprint Authentication</h3>
            <p className="text-slate-300 mb-6">Please scan your fingerprint to enable this feature</p>
      ...
      {show2FAModal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-slate-800 border border-slate-700 rounded-xl p-6 max-w-md w-full">
            ...
            <p className="text-slate-300 mb-6">Scan the QR code with your authenticator app</p>
