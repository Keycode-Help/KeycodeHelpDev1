            ...
            <div className="space-y-6">
              ...
              <div>
                <label className="block text-sm font-semibold text-white mb-3">
                  ...
                  {formData.industry !== "mechanic" && <span className="text-red-400">*</span>}
                  {formData.industry === "mechanic" && <span className="text-yellow-400">(Optional for Mobile Mechanics)</span>}
                </label>
                <input
                  type="file"
                  name="coi"
