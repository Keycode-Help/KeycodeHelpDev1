          ...
          <div className="flex-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-sm">
              ...
              <div className="flex items-center gap-2 sm:col-span-2">
                <span className="text-gray-600 w-16">Company:</span>
              ...
              <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-xl">
                ...
                {approvedAdmins.filter((f) => {
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-600 text-lg">No approved admins</p>
                    <p className="text-gray-500 text-sm mt-2">
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-xl">
              ...
              {actionLog.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-600 text-lg">No actions yet</p>
                  <p className="text-gray-500 text-sm mt-2">
