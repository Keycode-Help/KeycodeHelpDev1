...
const KchDatabase = () => {
  ...
  const searchEntries = useCallback(async (page = 0) => {
    setLoading(true);
    ...
    <div className="kch-database">
          ...
          <div className="onboarding-content">
            ...
            <div className="onboarding-tips">
              ...
              <div className="tip">
                ...
                <div>
                  <h4>Smart Filters</h4>
                  <p>Use filters to narrow down results by make, model, and year</p>
                </div>
              </div>
              <div className="tip">
          ...
          <div className="filters-grid">
            <div className="filter-group">
              ...
              <select
                ...
                onChange={(e) => handleFilterChange('makeId', e.target.value || null)}
            ...
            <div className="filter-group">
              ...
              <select
                ...
                onChange={(e) => handleFilterChange('modelId', e.target.value || null)}
                className="filter-select"
            ...
            <div className="filter-group">
              ...
              <input
                ...
                onChange={(e) => handleFilterChange('yearFrom', e.target.value || null)}
            ...
            <div className="filter-group">
              ...
              <input
                ...
                onChange={(e) => handleFilterChange('yearTo', e.target.value || null)}
                className="filter-input"
                placeholder="2024"
              />
            </div>
            ...
            <div className="filter-group">
              ...
              <select
                ...
                onChange={(e) => handleFilterChange('systemTypeId', e.target.value || null)}
                className="filter-select"
              >
            ...
            <div className="filter-group">
              ...
              <select
                ...
                onChange={(e) => handleFilterChange('transponderFamilyId', e.target.value || null)}
                className="filter-select"
              >
      ...
      {showCopyWarning && (
        <div className="copy-warning">
          ...
          <button onClick={() => setShowCopyWarning(false)} className="close-warning">
            <X />
          </button>
        </div>
      )}
    ...
    <div className="result-card">
      ...
      <div className="card-content">
        ...
        <div className="info-row">
          ...
          <span className="value">{entry.transponderFamily?.name || 'N/A'}</span>
        </div>
              ...
              <div className="info-section">
                ...
                <div className="tags">
                  {entry.crossRefs.map((ref, index) => (
                    <span key={index} className="tag">{ref.label}</span>
                  ))}
                </div>
              </div>
            )}
            ...
            {entry.notes && entry.notes.length > 0 && (
              <div className="info-section">
                ...
                {entry.notes.map((note, index) => (
                  <p key={index} className="note-text">{note.text}</p>
                ))}
              </div>
            )}
          </div>
