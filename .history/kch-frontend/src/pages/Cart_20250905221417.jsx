...
function SubscriptionCard({ tier, price, features, perks, onAdd, isDisabled }) {
  ...
  return (
    <div className="bg-gradient-to-br from-secondary/20 to-dark/20 border border-secondary/30 rounded-2xl p-6 backdrop-blur-sm shadow-xl hover:shadow-2xl transition-all duration-300" style={{ borderColor: getTierColor() }}>
      <div className="flex items-center gap-4 mb-4">
        <div className="w-12 h-12 flex items-center justify-center rounded-lg" style={{ color: getTierColor() }}>
          {getTierIcon()}
        </div>
        <div>
      ...
      <div className="cart-container">
        ...
        <div
          className={`cart-content ${
            cartItems.length === 0 ? "empty-cart-content" : ""
          }`}
        >
          {cartItems.length === 0 ? (
            <div className="empty-cart">
              ...
              <a href="/vehicle-keycode-request" className="inline-flex items-center justify-center gap-2 px-8 py-3 bg-gradient-to-r from-primary to-primary-dark text-white font-semibold rounded-xl hover:from-primary-dark hover:to-primary hover:-translate-y-1 hover:shadow-lg transition-all duration-300 shadow-lg focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
                Request Keycodes
              </a>
            </div>
          ) : (
                  ...
                  cartItems[0]?.isTemporary && (
                    <div className="temp-vehicle-actions">
                      ...
                      <button
                        ...
                        className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-secondary to-secondary-dark text-white font-semibold rounded-xl hover:from-secondary-dark hover:to-secondary hover:-translate-y-1 hover:shadow-lg transition-all duration-300 shadow-lg focus:outline-none focus:ring-2 focus:ring-secondary focus:ring-offset-2"
                      >
