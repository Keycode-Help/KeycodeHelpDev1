...
const UpdateUserProfile = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark via-secondary to-dark p-4 relative overflow-hidden">
      {/* Background Effects */}
                ...
                <div>
                  ...
                  <div className="mt-2 flex gap-2">
                    <button
                      ...
                      className="text-sm text-white/60 hover:text-white/70 transition-colors duration-200"
                    >
                      Reset
                    </button>
                  </div>
