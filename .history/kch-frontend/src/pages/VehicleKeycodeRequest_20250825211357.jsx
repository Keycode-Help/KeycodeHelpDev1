      ...
      <div className="keycode-request-container">
        ...
        {!user && (
          <div className="guest-notice">
            <p style={{ color: "#f59e0b", fontSize: "0.9rem", textAlign: "center", marginBottom: "20px" }}>
              ⚠️ <strong>Guest Users:</strong> Driver's license photos required for identity verification
            </p>
          </div>
        )}
