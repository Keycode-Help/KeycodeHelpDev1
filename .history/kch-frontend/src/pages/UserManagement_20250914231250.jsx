...
function UserManagement() {
  ...
  const getUserStatus = (user) => {
    ...
    // For now, we'll use isActive field as a proxy since we don't have lastLogin
    // TODO: Add lastLogin field to user model for proper inactive detection
    if (!user.isActive) {
      return "inactive";
    }
        ...
        {user.trialEndsAt && (
          <div className="mb-4 p-3 rounded-lg border border-slate-600/50 bg-slate-800/30">
            <div className="flex items-center gap-2 mb-2">
              ...
              <span className="text-sm font-medium text-blue-300">Trial Period</span>
            </div>
            <div className="grid grid-cols-2 gap-4 text-sm">
              <div>
                <span className="text-white/60 text-xs font-medium">Started:</span>
              ...
              <div>
                <span className="text-white/60 text-xs font-medium">Expires:</span>
                <div className="text-white font-medium">
