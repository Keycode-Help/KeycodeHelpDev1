  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark via-secondary to-dark flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-2xl">
        <div className="bg-gradient-to-br from-secondary/50 to-dark/50 backdrop-blur-sm border border-secondary rounded-2xl p-8 shadow-2xl">
          {/* Header */}
          <div className="text-center mb-8">
            ...
            <p className="text-white/70">Join our professional network</p>
          </div>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <input
                  ...
                  required
                  className={`w-full px-4 py-3 bg-white border rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 ${
                    errors.fname
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className={`w-full px-4 py-3 pr-12 bg-white border border-gray-300 rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 ${
                      errors.password
                        ? "border-red-500 focus:ring-red-500"
                        : "border-gray-300 focus:ring-blue-500"
                    }`}
                  ...
                  <button
                    ...
                    className="absolute right-3 top-1/2 transform -translate-y-1/2 text-white/60 hover:text-gray-800 transition-colors duration-200"
                    aria-label={
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    required
                    className={`w-full px-4 py-3 pr-12 bg-surface/50 border border-secondary rounded-xl text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-200 ${
