...
export default function SubscriptionManager() {
  ...
  const isTrialMode = url.pathname === "/membership" && url.searchParams.get("trial") === "start";
        ...
        {isTrialMode ? (
          <>
            <div className="text-center mb-12">
              <h1 className="text-4xl font-bold text-white mb-4">Start Your 3-Day Premium Trial</h1>
              <p className="text-xl text-gray-300 max-w-3xl mx-auto">
                Enjoy full access to premium features for 3 days. No commitment. Experience faster processing, expanded database access, and priority support.
              </p>
            </div>
            <div className="grid md:grid-cols-3 gap-6 mb-10">
              ...
              <div className="rounded-3xl border border-white/10 bg-black/40 p-6">
                <h3 className="text-white font-semibold mb-2">How trial works</h3>
                <ul className="list-disc pl-5 text-gray-300 space-y-1 text-sm">
            ...
            <div className="text-center">
              <button
                onClick={() => handleSubscribe({ id: 2, title: "Professional", price: 24.99, period: "month", features: [], perks: [] })}
                className="px-8 py-3 bg-yellow-500 text-black font-semibold rounded-xl hover:bg-yellow-400 transition-colors"
              >
                Activate Trial Now
              </button>
              <p className="text-gray-400 text-sm mt-3">After 3 days, pick a plan to continue premium access. No charge during trial.</p>
            </div>
          </>
        ) : (
          <>
