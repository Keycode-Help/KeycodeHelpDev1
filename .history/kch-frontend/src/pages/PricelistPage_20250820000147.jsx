...
const PricelistPage = () => {
  ...
  const manufacturerPricing = {
    "Acura/Honda": {
      ...
      popularModels: ["MDX", "RDX", "TLX", "NSX", "CR-V", "Accord", "Civic", "Pilot"],
    ...
    "Chrysler": {
      ...
      features: ["Chrysler certified", "Priority processing", "Quick turnaround"],
    ...
    "Dodge/Jeep": {
      ...
      popularModels: ["Challenger", "Charger", "Durango", "Wrangler", "Grand Cherokee"],
    ...
    "Ford/Lincoln/Mercury": {
      ...
      popularModels: ["F-150", "Explorer", "Mustang", "Bronco", "Navigator", "Continental"],
    ...
    "Hyundai": {
      ...
      popularModels: ["Tucson", "Santa Fe", "Elantra", "Palisade", "Sonata", "Venue"],
    ...
    "Nissan": {
      ...
      popularModels: ["Rogue", "Altima", "Maxima", "Armada", "Sentra", "Pathfinder"],
    ...
    "Toyota/Lexus": {
      ...
      popularModels: ["RAV4", "Camry", "Highlander", "Tacoma", "RX", "ES", "NX", "LS"],
    ...
    "Chevy/GM": {
      ...
      popularModels: ["Silverado", "Equinox", "Camaro", "Corvette", "Tahoe", "Suburban"],
    ...
    "Subaru": {
      ...
      nonMemberPrice: 75,
      memberPrice: 60,
      description: "Love - it's what makes a Subaru - dependable keycode solutions",
      popularModels: ["Forester", "Outback", "Crosstrek", "Impreza", "WRX", "Ascent"],
      ...
      <div className="bg-gradient-to-r from-blue-900 to-purple-900 py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl text-blue-100 max-w-3xl mx-auto">
            Transparent pricing for every vehicle brand. Members save significantly on keycode requests. 
            Some vehicles require additional PIN codes which are included in member pricing.
          </p>
        </div>
      </div>
                ...
                <div className="space-y-4 mb-6">
                  <div className="bg-gray-700 rounded-lg p-4">
                    <div className="flex justify-between items-center mb-2">
                      ...
                      <span className="text-2xl font-bold text-white">${data.nonMemberPrice}</span>
                    </div>
          ...
          <div className="max-w-4xl mx-auto space-y-6">
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-300">
                Members get significant discounts on keycode requests. For example, Hyundai keycodes 
                cost $60 for non-members but only $38 for members. Some vehicles require additional 
            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-300">
                Chrysler, Dodge/Jeep, Infiniti, and Nissan vehicles require both a keycode and PIN code. 
                For members, PIN codes are included. For non-members, PIN codes cost an additional $20.
              </p>
            </div>
            ...
            <div className="bg-gray-800 rounded-lg p-6">
              ...
              <p className="text-gray-300">
                Yes! For 100+ keycode requests, we offer significant discounts at $0.50 per request. 
