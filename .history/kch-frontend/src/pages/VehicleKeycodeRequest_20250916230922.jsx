          ...
          <div className="bg-gradient-to-r from-slate-700/20 to-slate-800/20 border border-slate-600/50 rounded-xl p-4 mb-6">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-gray-300 leading-relaxed">
                <p>
                  <strong className="text-white">Availability Notice:</strong>{" "}
                  Some keycodes may not be available due to vehicle year, model
                  variations, or data limitations. In cases where we cannot
                  provide your requested keycode, you will be eligible for a
                  full refund. We'll notify you within 24-48 hours if your
                  specific vehicle cannot be serviced.
                </p>
              </div>
            </div>
          </div>
