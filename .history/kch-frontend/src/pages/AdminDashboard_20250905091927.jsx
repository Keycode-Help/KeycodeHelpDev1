...
function AdminDashboard() {
  ...
  const handleApiError = (error, defaultMessage) => {
    ...
    if (error.response?.status === 403) {
      errorMessage = "Access denied. You don't have admin privileges or your session has expired.";
          ...
          <div className="bg-gradient-to-br from-red-500/10 to-orange-500/10 border border-red-500/20 rounded-3xl p-8 shadow-xl">
            <div className="text-center">
              ...
              <p className="text-gray-300 text-lg mb-6">
                This dashboard is only accessible to users with admin or super admin privileges.
              </p>
              <div className="space-y-2 text-sm text-gray-400">
                <p>Your current role: <span className="text-white font-semibold">{userRole || 'Unknown'}</span></p>
                <p>Required roles: <span className="text-white font-semibold">ADMIN or SUPER_ADMIN</span></p>
              </div>
            </div>
          </div>
        </div>
