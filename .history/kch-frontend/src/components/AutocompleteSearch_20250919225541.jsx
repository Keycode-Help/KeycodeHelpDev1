        ...
        <div className="relative w-full transition-all duration-300 shadow-lg">
          ...
          <div className="relative flex items-center bg-gradient-to-r from-slate-800/80 to-slate-900/80 backdrop-blur-xl border border-slate-600/50 rounded-2xl overflow-hidden shadow-lg">
            ...
            <input
              ...
              className="flex-1 bg-transparent px-6 py-5 text-gray-900 placeholder-gray-500 text-lg font-medium focus:outline-none transition-all duration-300 min-w-0"
              autoComplete="off"
              spellCheck="false"
            />
            ...
            {value && (
              <button
                ...
                tabIndex="-1"
              >
                <X className="w-5 h-5 text-gray-600 group-hover:text-white transition-colors duration-200" />
              </button>
            )}
