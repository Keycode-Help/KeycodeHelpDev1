...
export default function TrialNotice() {
  ...
  return (
    <div className="bg-gradient-to-br from-success/10 to-success/20 border border-success/20 rounded-2xl p-6 backdrop-blur-sm shadow-xl relative overflow-hidden" style={{ marginTop: 12 }}>
