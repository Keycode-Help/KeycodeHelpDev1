...
const Footer = () => {
  ...
  return (
    <footer
      className="bg-gradient-to-br from-dark via-secondary to-dark border-t border-secondary relative overflow-hidden"
      style={{
        background:
          "linear-gradient(to bottom right, #000000, #213341, #000000) !important",
      }}
    >
      {/* Background Effects */}
