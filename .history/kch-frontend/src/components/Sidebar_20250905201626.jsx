      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-secondary">
          ...
          <button
            ...
            className="p-2 rounded-lg hover:bg-secondary/50 hover:scale-105 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 focus:ring-offset-slate-800"
          >
            {isCollapsed ? (
          ...
          {Object.entries(navItems).map(([category, items]) => (
            <div key={category} className="mb-6">
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2 text-sm font-semibold text-white/70 hover:text-white hover:bg-secondary/50/30 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 focus:ring-offset-slate-800 ${
