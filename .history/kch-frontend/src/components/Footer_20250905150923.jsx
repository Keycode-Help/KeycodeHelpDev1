...
const Footer = () => {
  ...
  return (
    <footer
      className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 border-t border-slate-700 relative overflow-hidden"
      style={{
        background:
          "linear-gradient(to bottom right, #0f172a, #1e293b, #0f172a) !important",
      }}
    >
      {/* Background Effects */}
