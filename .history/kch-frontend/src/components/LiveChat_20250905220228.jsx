...
export default function LiveChat({ visible }) {
  ...
  if (!open) {
    return (
      <button
        className="fixed bottom-4 right-4 inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-primary to-primary-dark text-white font-semibold rounded-full hover:from-primary-dark hover:to-primary hover:-translate-y-1 hover:shadow-lg transition-all duration-300 shadow-lg focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2"
  ...
  return (
    <div className="fixed bottom-4 right-4 w-80 rounded-2xl border border-neutral-800 bg-black/70 backdrop-blur p-3 text-gray-200 shadow-2xl">
      ...
      <form onSubmit={send} className="mt-2 flex items-center gap-2">
        ...
        />
        <button type="submit" className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-gradient-to-r from-primary to-primary-dark text-white font-semibold rounded-xl hover:from-primary-dark hover:to-primary hover:-translate-y-1 hover:shadow-lg transition-all duration-300 shadow-lg focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2">
          Send
        </button>
      </form>
    </div>
