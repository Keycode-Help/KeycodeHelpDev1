...
function OfflineIndicator() {
  ...
  return (
    <>
      ...
      {showDetails && (
        <div
          className="fixed top-16 right-4 z-50 bg-slate-800/95 backdrop-blur-sm border border-slate-700 rounded-xl p-4 shadow-xl min-w-80"
        >
          <div className="space-y-3">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm text-white">{getConnectionTypeDisplay()}</span>
              </div>

              {!isOnline && (
                <div className="flex items-center justify-between">
                  <span className="text-sm text-slate-300">Offline Duration:</span>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-amber-200">
                      Some features may be limited. Your actions will be synced when you're back online.
                    </p>
                  </div>
                </div>
              </div>
