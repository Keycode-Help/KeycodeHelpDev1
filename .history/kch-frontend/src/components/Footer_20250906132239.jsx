...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-br from-dark via-secondary to-dark border-t border-secondary relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="relative z-10">
            ...
            <div className="space-y-6">
              <div>
                <h4 className="text-xl font-semibold text-white mb-6 relative">
                  Quick Links
                  <div className="absolute -bottom-2 left-0 w-8 h-0.5 bg-gradient-to-r from-blue-400 to-yellow-400 rounded-full"></div>
                </h4>
                <ul className="space-y-4">
                  <li>
                    <Link
                      to="/"
                      className="text-white/90 hover:text-blue-400 transition-colors duration-200 hover:translate-x-1 inline-block"
                    >
                      Home
                    </Link>
                  </li>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-secondary bg-dark/50 backdrop-blur-sm">
