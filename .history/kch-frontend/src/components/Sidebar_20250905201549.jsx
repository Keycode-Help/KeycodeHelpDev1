    ...
    <>
          ...
          {Object.entries(navItems).map(([category, items]) => (
            <div key={category} className="mb-6">
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2 text-sm font-semibold text-white/70 hover:text-white hover:bg-slate-700/30 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 focus:ring-offset-slate-800 ${
      ...
      {isMobile && isCollapsed && (
        <button
          ...
          className="fixed top-4 left-4 z-50 p-3 bg-slate-800/90 backdrop-blur-sm rounded-lg shadow-lg border border-secondary hover:bg-slate-700 hover:scale-105 active:scale-95 transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:ring-offset-2 focus:ring-offset-slate-900"
        >
          <Menu className="h-5 w-5 text-white" />
        </button>
      )}
