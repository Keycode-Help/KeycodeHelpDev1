    ...
    fields.push(
      <FormField
        ...
        rightElement={
          ...
          >
            <Icon name={showPassword ? "eyeOff" : "eye"} size={20} className="drop-shadow-none filter-none" />
          </button>
        }
      />
    );
      ...
      fields.push(
        <FormField
          ...
          rightElement={
            ...
            >
              <Icon name={showConfirmPassword ? "eyeOff" : "eye"} size={20} className="drop-shadow-none filter-none" />
            </button>
          }
        />
      );
