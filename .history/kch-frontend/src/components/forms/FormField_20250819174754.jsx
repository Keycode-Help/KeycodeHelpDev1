      ...
      <div className="relative">
        ...
        {rightElement && (
          <div className="absolute inset-y-0 right-0 flex items-center justify-center w-12 pointer-events-none">
            <div className="pointer-events-auto flex items-center justify-center w-10 h-10 bg-gray-700 rounded-md hover:bg-gray-600 transition-colors duration-200 shadow-none">
              <div className="w-6 h-6 flex items-center justify-center overflow-hidden password-toggle-icon">
                {rightElement}
              </div>
            </div>
          </div>
