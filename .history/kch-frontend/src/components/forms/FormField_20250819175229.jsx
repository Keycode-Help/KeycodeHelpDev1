  ...
  return (
    <label className="block mb-8">
      ...
      <div className="relative">
        ...
        />
        {rightElement && (
          <div className="absolute inset-y-0 right-2 flex items-center justify-center w-8 pointer-events-none">
            <div className="pointer-events-auto flex items-center justify-center w-6 h-6 bg-gray-700 rounded-md hover:bg-gray-600 transition-colors duration-200 shadow-none">
              <div className="w-4 h-4 flex items-center justify-center overflow-hidden password-toggle-icon">
                {rightElement}
              </div>
            </div>
          </div>
