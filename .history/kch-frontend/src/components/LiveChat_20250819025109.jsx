...
export default function LiveChat({ visible }) {
  ...
  if (!open) {
    return (
      <button
        className="fixed bottom-4 right-4 rounded-full bg-yellow-500/90 hover:bg-yellow-500 text-black font-semibold px-4 py-2 shadow-xl border border-neutral-800"
    ...
    <div className="fixed bottom-4 right-4 w-80 rounded-2xl border border-neutral-800 bg-black/70 backdrop-blur p-3 text-gray-200 shadow-2xl">
      <div className="flex items-center justify-between mb-2">
        ...
        <button
          ...
          className="rounded-lg px-2 py-1 text-gray-300 hover:text-white hover:bg-white/10"
