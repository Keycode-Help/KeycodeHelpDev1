...
const TopNavbar = () => {
  ...
  return (
    <nav className="bg-gradient-to-r from-dark via-secondary to-dark border-b border-secondary sticky top-0 z-50 backdrop-blur-sm">
        ...
        <div className="flex items-center justify-between h-16">
                  ...
                  <Link
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
                      isActive(link.path)
                        ...
                        : "text-white/70 hover:text-blue-400 hover:bg-secondary/50"
                    }`}
                  >
          ...
          <div className="flex items-center gap-3">
            {isAuthenticated ? (
              ...
              <>
                ...
                <button
                  onClick={logout}
                  className="flex items-center gap-2 px-4 py-2 text-sm font-medium text-white/70 hover:text-white hover:bg-secondary/50 rounded-lg transition-all duration-200"
                >
          ...
          <div className="md:hidden">
            <button
              ...
              className="text-white/70 hover:text-white hover:bg-secondary/50 p-2 rounded-lg transition-all duration-200"
              aria-label={
            ...
            <div className="flex flex-col space-y-2">
              ...
              {isAuthenticated ? (
                <div className="border-t border-secondary pt-2 mt-2">
                  ...
                  <button
                    onClick={logout}
                    className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-white/70 hover:text-white hover:bg-secondary/50 rounded-lg transition-all duration-200 w-full text-left"
                  >
                    <LogOut className="h-4 w-4" />
                    Logout
                  </button>
                ...
                <div className="border-t border-secondary pt-2 mt-2">
                  <Link
                    to="/login"
                    className="flex items-center gap-2 px-3 py-2 text-sm font-medium text-white/70 hover:text-white hover:bg-secondary/50 rounded-lg transition-all duration-200"
                  >
                    <LogIn className="h-4 w-4" />
                    Login
                  </Link>
