...
export default function RequestCard({
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-gray-800 bg-gradient-to-b from-[#10131a] to-[#0b0e13] p-5 shadow-[0_0_0_1px_rgba(255,255,255,0.02)]">
      <div className="absolute inset-0 -z-10 opacity-0 blur-xl transition-opacity duration-300 group-hover:opacity-20" style={{background:"radial-gradient(600px circle at var(--x,50%) var(--y,50%), rgba(11,65,228,.15), transparent 40%)"}} />
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            onClick={() => onPreview(`data:image/jpeg;base64,${request.frontId}`)}
          >
