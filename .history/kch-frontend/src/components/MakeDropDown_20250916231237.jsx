...
const MakeDropDown = ({ selectedMake, options, onChange }) => {
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      {isOpen && (
        <div className="absolute z-[9999] w-full mt-2 bg-slate-900 border border-slate-600 rounded-xl shadow-2xl max-h-80 overflow-y-auto scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-transparent">
          <div className="p-2">
            {options.length === 0 ? (
