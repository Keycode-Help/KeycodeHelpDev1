        ...
        <div className="grid md:grid-cols-3 gap-8 relative">
          {steps.map((item, index) => (
            ...
            >
              ...
              {/* Content Box */}
              <div
                className={`text-center space-y-3 transition-opacity duration-300
                                     ${
                                       index === activeStep
                                         ? "opacity-100"
                                         : "opacity-70"
              ...
              >
                ...
                >
                  <p className="text-sm text-white/60 mt-2">{item.details}</p>
                </div>
              </div>
            </div>
          ))}
