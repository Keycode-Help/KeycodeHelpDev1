    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, CorsConfigurationSource corsConfigurationSource) throws Exception {
        http
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers("/", "/actuator/health", "/css/**", "/js/**", "/images/**", "/register", "/send-email", "/makes/**", "/compliance/status", "/compliance/status/public", "/cart/items/public", "/api/payments/create-checkout-session", "/api/kch/**", "/test/**").permitAll()
                        .requestMatchers("/auth/login", "/auth/register", "/auth/admin-register", "/auth/refresh", "/auth/test", "/auth/test-auth", "/auth/dev-set-password", "/auth/dev-upsert-admin", "/auth/dev-upsert-user", "/auth/reset-password", "/auth/reset-password/confirm", "/auth/setup-super-admin", "/auth/debug/**").permitAll()
                        .requestMatchers("/admin/admin-logs-public", "/admin/admin-logs-test", "/admin/admin-logs-simple").permitAll()
                        .requestMatchers("/admin/**", "/admin-approval/**", "/user-approval/**").hasAnyRole("ADMIN", "SUPER_ADMIN")
