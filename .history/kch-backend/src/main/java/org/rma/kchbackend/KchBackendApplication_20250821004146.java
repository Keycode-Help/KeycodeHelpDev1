    ...
    public void initializeDatabase() {
        try {
            ...
            try {
                ...
                System.out.println("❌ keycode_user table still doesn't exist - schema.sql failed");
            ...
            try {
                ...
                System.out.println("❌ vehicle table still doesn't exist - schema.sql failed");
                System.err.println("Error: " + e.getMessage());
            }
            ...
            try {
                ...
                System.out.println("❌ password_reset_tokens table still doesn't exist - schema.sql failed");
                System.err.println("Error: " + e.getMessage());
            }
