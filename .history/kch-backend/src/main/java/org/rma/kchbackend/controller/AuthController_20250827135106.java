...
public class AuthController {
    ...
    public ResponseEntity<?> login(@Valid @RequestBody LoginRequest loginRequest, BindingResult bindingResult) {
        ...
        System.out.println("  Email: " + (loginRequest != null ? loginRequest.getEmail() : "NULL"));
        System.out.println("  Password: " + (loginRequest != null ? (loginRequest.getPassword() != null ? "***SET***" : "NULL") : "NULL"));
        System.out.println("  Binding Result Errors: " + (bindingResult != null ? bindingResult.hasErrors() : "NULL"));
