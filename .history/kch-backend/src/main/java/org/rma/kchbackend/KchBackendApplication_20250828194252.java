...
public class KchBackendApplication {
    ...
    private static void loadEnvironmentVariables(Dotenv dotenv) {
        ...
        for (String oem : oems) {
            ...
            if (passValue != null) {
                System.setProperty(passKey, "***SET***");
                System.out.println("✅ Set " + passKey + ": ***SET***");
            }
        }
        
        // Re-enable schema initialization now that compilation errors are fixed
        ...
        System.out.println("✅ Schema initialization re-enabled");
