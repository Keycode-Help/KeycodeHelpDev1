...
public class KchBackendApplication {
    ...
    private static void loadEnvironmentVariables(Dotenv dotenv) {
        ...
        String supabaseJwtSecret = getValue("SUPABASE_JWT_SECRET", dotenv);
        if (supabaseJwtSecret != null) {
            System.setProperty("SUPABASE_JWT_SECRET", supabaseJwtSecret);
            System.out.println("✅ Set SUPABASE_JWT_SECRET: ***SET***");
        }
        ...
        // Enable schema initialization for automatic setup
        ...
        System.out.println("✅ Schema initialization enabled");
        System.out.println("✅ schema.sql will be applied automatically");
        System.out.println("✅ Database will be initialized on startup");
    }
