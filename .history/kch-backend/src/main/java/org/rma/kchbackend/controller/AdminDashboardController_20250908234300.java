...
public class AdminDashboardController {
    ...
    private byte[] compressImageIfNeeded(byte[] image, String mimeType) {
        ...
        try {
            ...
            // In a production environment, you'd want to use ImageIO or similar
            // to resize/compress the image to a maximum width/height
    ...
    public ResponseEntity<Map<String, Object>> debugImages() {
        ...
        try {
            ...
            List<KeycodeUser> users = keycodeUserService.findAll();
            if (!users.isEmpty()) {
            ...
            // Get a sample vehicle with images
