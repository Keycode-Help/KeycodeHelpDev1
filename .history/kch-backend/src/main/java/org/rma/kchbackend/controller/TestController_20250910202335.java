...
public class TestController {
    ...
    public ResponseEntity<String> createTestUsers() {
        try {
            ...
            trialSubscription.setUser(trialUser);
            trialSubscription.setTrial(true);
            trialSubscription.setTrialEndsAt(LocalDateTime.now().plusDays(3));
            ...
            expiredTrialSubscription.setUser(expiredTrialUser);
            expiredTrialSubscription.setTrial(true);
            expiredTrialSubscription.setTrialEndsAt(LocalDateTime.now().minusDays(1));
            expiredTrialSubscription.setActivated(false);
            expiredTrialSubscription.setCreatedAt(LocalDateTime.now().minusDays(4));
