...
This document defines the unified color system used throughout the KeycodeHelp application. All colors are defined as tailwind properties (variables) in `tailwind` and should be used consistently across all components.
