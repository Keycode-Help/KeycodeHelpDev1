...
function VehicleKeycodeRequest() {
  ...
  const setMakePrice = (selectedMakeValue) => {
    ...
    if (selectedMakeValue) {
      // Get the customer-facing prices from the vehicle database
      ...
      console.log(`Pricing for ${selectedMakeValue}: Non-Member $${nonMemberPrice}, Member $${memberPrice}`);
    } else {
