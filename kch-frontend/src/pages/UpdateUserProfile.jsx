...
import StatesDropDownProfile from "../components/UpdateProfile/StatesDropDownProfile.jsx";
...
const UpdateUserProfile = () => {
  ...
  const fetchUserProfile = async () => {
    try {
      ...
      if(userData) {
        setDisplayInitials(userData.fname[0].toUpperCase() + userData.lname[0].toUpperCase());
      }
