        ...
        <div className="bg-dark text-white min-h-screen">
            ...
            <header className="flex items-center justify-between px-8 py-6 border-b border-navy">
                ...
                <nav className="flex items-center space-x-8">
                    <Link to="/keycode-service" className="nav-link">Get KeyCode</Link>
            ...
            <main className="max-w-7xl mx-auto px-8 py-12 space-y-16">
                ...
                <div className="bento-container bg-primary/10 border-primary/20">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4 p-4">
                        <p className="text-white/90 font-medium flex items-center gap-2">
                            ...
                            Need a key code? Get it within 5-30 minutes. No membership required.
                        </p>
                        <button className="btn-cta whitespace-nowrap flex items-center gap-2">
                ...
                <section className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="space-y-6">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <button className="btn-cta animate-pulse flex items-center gap-2">
                ...
                <section className="grid md:grid-cols-3 gap-8">
                    ...
                    <div className="bento-item">
                        ...
                        <button className="btn-cta w-full flex items-center gap-2 justify-center">
                    ...
                    <div className="bento-item">
                        ...
                        <p className="text-white/80 mb-6">Save on every order with premium benefits</p>
                    ...
                    <div className="bento-item">
                        ...
                        <p className="text-white/80 mb-6">Technical assistance for all users</p>
                        <button className="btn-primary w-full flex items-center gap-2 justify-center">
